...
**Last updated:** 2026-05-24 end-of-day (Pass 7 PRR complete on all 127 audit-able entries; Problem 8 RESOLVED-IN-PRINCIPLE with 330 Subject-paragraph corrections captured in `subject_paragraph_corrections_pass7.json`; Codex inherits the Smithsonian-grade publication gate ready to apply)
...
## Problem 8 — Subject-paragraph publication-blocking corrections — **RESOLVED-IN-PRINCIPLE 2026-05-24 (Pass 7 PRR)**

### Resolved 2026-05-24 (Pass 7 PRR)
...
**Why "resolved-in-principle" not "fully resolved":**

# Layer 5 fidelity findings — entry #89 Michael D. McCarty
...
|---|---|---|---|---:|---|
| `89.15` | Pass 1 | March 8, 1971 — Ali Frazier | March 8, 1971 (Muhammad Ali vs. Joe Frazier "Fight of the Century") | 0.0 | low-impact |
| `89.P2.55` | Pass 2 | Jean Seberg (uncertain — actress in LA destroyed by FBI) | Jean Seberg | 0.0 | low-impact |
| `89.P2.57` | Pass 2 | The Burglary by Betty Medsger | *The Burglary* by Betty Medsger (2014) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Crestwood, Illinois | Crestwood, Illinois | 2 | 3 |
| ? | confirming catalog | confirming pattern | 2 | 2 |
| ? | Southern Oral History Program (SOHP) | Southern Oral History Program (SOHP) | 2 | 2 |
| ? | Southern Oral History Program (SOHP) | Southern Oral History Program (SOHP) | 2 | 2 |
...
The annotations in the master MD's `### 89. Michael D. McCarty` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

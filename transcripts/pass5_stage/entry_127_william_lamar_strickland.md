# Layer 5 fidelity findings — entry #127 William Lamar Strickland
...
|---|---|---|---|---:|---|
| `127.28` | Pass 1 | James Boggs + Grace Boggs | James Boggs + Grace Lee Boggs | 0.0 | low-impact |
| `127.44` | Pass 1 | Stokely Carmichael | Stokely Carmichael / Kwame Ture | 0.0 | low-impact |
| `127.P2.9` | Pass 2 | one Boston Latin | Boston Latin School | 0.0 | low-impact |
| `127.P2.130` | Pass 2 | Henry Hampton's organization, Blackside | Henry Hampton + Blackside Inc. | 0.0 | low-impact |
| `127.P4.15` | Pass 4 | "in the 200 [rebellions] that occurred, I think, after Martin's assassination" | the 1968 nationwide urban rebellions after MLK's April 4, 1968 assassination | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Parris Island + the Camp + then "Le Jeune" (Camp Lejeune NC) | Parris Island | 2 | 2 |
| ? | Erik Erikson | Erik Erikson | 2 | 2 |
| ? | Carl McCall | Carl McCall | 2 | 2 |
| ? | (likely) Manny Schoenberg / Marvin Sherman | (likely) Manny Schoenberg / Marvin Sherman | 2 | 2 |
| ? | (likely) Manny Schoenberg / Marvin Sherman | (likely) Manny Schoenberg / Marvin Sherman | 2 | 2 |
| ? | Emmanuel Wallerstein (likely Immanuel Wallerstein) | Emmanuel Wallerstein (likely Immanuel Wallerstein) | 2 | 2 |
...
The annotations in the master MD's `### 127. William Lamar Strickland` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #47 Gloria Arellanes
...
|---|---:|
| D1 — Phantom Whisper-renderings | 1 (0 canonical-figure / 1 low-impact) |
...
|---|---|---|---|---:|---|
| `47.P2.18` | Pass 2 | Maulana Karenga's US Organization (every Sunday) | US Organization (Maulana Karenga's group) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Chicanos | Whisper substitution for Chicanos / Black radicals (per #47. | 3 | 3 |
| ? | Tongva | Tongva | 2 | 3 |
| ? | Maravilla projects | Maravilla projects | 2 | 2 |
| ? | vaquero / vaqueros | vaquero / vaqueros | 2 | 2 |
| ? | vaquero / vaqueros | vaquero / vaqueros | 2 | 2 |
| ? | Watts rebellion / Watts uprising | Watts rebellion / Watts uprising | 2 | 2 |
| ? | a 70-year-old | a 70-year-old | 2 | 2 |
...
|---|---|---|---|---|---|
| `47.P3.1` | "ditch guns" → Chicanos cross-corpus erasure | catalog category G entry needed | Whisper substitution for Chicanos / Black radicals (per #47. | D-ext |  |
...
- **1 low-impact phantoms** for this entry were PHYSICALLY REMOVED from the master MD (would have silently no-op'd anyway)
...
The annotations in the master MD's `### 47. Gloria Arellanes` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #14 Cecil J. Williams
...
|---|---|---|---|---:|---|
| `14.41` | Pass 1 | Henderson case | *Henderson v. United States* (1950) | 0.0 | low-impact |
| `14.42` | Pass 1 | Franklin Williams | Franklin H. Williams | 0.0 | low-impact |
| `14.P2.10` | Pass 2 | Briggs vs Elliot | *Briggs v. Elliott* (1949 SC) | 0.0 | low-impact |
| `14.P4.18` | Pass 4 | "Sun Tajan Kennedy" | Senator John Kennedy / Sen.-then John F. Kennedy | 0.0 | low-impact |
| `14.P4.21` | Pass 4 | "Reverend Joseph DeLaine / J.A. Delayne / D'Layne / Reverend J.A. Delayne" | Rev. Joseph Armstrong DeLaine | 0.0 | low-impact |
| `14.P4.26` | Pass 4 | "Olin Mills" / "Captain Midnight cinema" | (cultural-context; no correction needed) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | John Bishop (cameraman) | John W. Walker | 4 | 4 |
| ? | E.C. Jones (Edgar C. Jones) | E.C. Jones (Edgar C. Jones) | 2 | 2 |
| ? | Belk-Hudson (likely) / Bell-Hudson | Belk-Hudson (likely) / Bell-Hudson | 2 | 2 |
| ? | Belk's (department store) | Belk's (department store) | 2 | 2 |
| ? | B.C. Turner (Benner C. Turner) | B.C. Turner (Benner C. Turner) | 2 | 2 |
| ? | Dr. H.V. Manning | Dr. H.V. Manning | 2 | 2 |
| ? | Strom Thurmond (likely) / Senator (Ernest) Hollings (possibl | Strom Thurmond (likely) / Senator (Ernest) Hollings (possibl | 2 | 2 |
| ? | Civil Rights Act (of 1964) | Civil Rights Act (of 1964) | 2 | 2 |
| ? | Voting Rights Act (of 1965) | Voting Rights Act (of 1965) | 2 | 2 |
| ? | Justice Ernest A. Finney Jr. | Justice Ernest A. Finney Jr. | 2 | 2 |
| ? | Voting Rights Act of 1965 | Voting Rights Act of 1965 | 2 | 2 |
| ? | Joe Mosnier (Southern Oral History Program / UNC) | Joe Mosnier (Southern Oral History Program / UNC) | 2 | 2 |
...
The annotations in the master MD's `### 14. Cecil J. Williams` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

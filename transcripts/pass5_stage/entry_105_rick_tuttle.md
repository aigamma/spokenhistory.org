# Layer 5 fidelity findings — entry #105 Rick Tuttle
...
|---|---|---|---|---:|---|
| `105.30` | Pass 1 | Mrs. Tellham | (Emmett) Till | 0.0 | low-impact |
| `105.P2.18` | Pass 2 | the Joseo Williams collection at the library in Atlanta | Hosea Williams archive at the Auburn Avenue Research Library on African American | 0.0 | low-impact |
| `105.P2.63` | Pass 2 | Voting Rights Act 1965 (re federal pre-clearance) | Voting Rights Act of 1965 (Section 5 federal pre-clearance) | 0.0 | low-impact |
| `105.P2.72` | Pass 2 | the Solicitor General of Georgia | Attorney General of Georgia | 0.0 | low-impact |
| `105.P2.74` | Pass 2 | the apartheid fight | LA divestment from South Africa | 0.0 | low-impact |
| `105.P2.85` | Pass 2 | Wesleyan classmate Steve Trott | Stephen S. Trott | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Rev. Hosea Williams | Hosea Williams | 2 | 10 |
| ? | Rebecca Tuttle (Rick Tuttle's second wife) | Rebecca McDonald | 2 | 2 |
| ? | Fannie Lou Hamer | Mrs. (Fannie Lou) Hamer | 2 | 2 |
| ? | Willie Wazir Peacock | Wazir Peacock (Willie Wazir Peacock) | 2 | 2 |
| ? | not in Tuttle transcript | Mr. Pendman / Pendman's Restaurant | 2 | 2 |
| ? | Peter D. Bird (or Peter Dibroy) | Peter D. Bird (or Peter Dibroy) | 2 | 2 |
| ? | Aaron Buchsbaum | Aaron Buchsbaum | 2 | 2 |
| ? | Senator (Russell B.) Eastland | Senator (Russell B.) Eastland | 2 | 2 |
...
The annotations in the master MD's `### 105. Rick Tuttle` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

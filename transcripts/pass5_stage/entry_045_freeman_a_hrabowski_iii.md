# Layer 5 fidelity findings — entry #45 Freeman A. Hrabowski III
...
|---|---|---|---|---:|---|
| `45.29` | Pass 1 | the children's march / Children's Crusade | the Birmingham Children's Crusade (May 2-7, 1963) | 0.0 | low-impact |
| `45.30` | Pass 1 | Phillips, Ramsey high school | Phillips High School / Ramsay High School | 0.0 | low-impact |
| `45.P2.2` | Pass 2 | the Negro Superintendent of Birmingham Colored Schools, Dr. Carol Hayes | Dr. C.R. Hayes (likely Dr. Charles R. Hayes; canonical 1940s-50s Birmingham AL B | 0.0 | low-impact |
| `45.P2.18` | Pass 2 | "I had a Godfather" Hayes | Dr. C.R. Hayes (Hrabowski's Godfather) | 0.0 | low-impact |
| `45.P2.20` | Pass 2 | I'd-be-a-nerd / nerds-that-are-still-raw | "nerves that are still raw" | 0.0 | low-impact |
| `45.P2.26` | Pass 2 | Connie's father / Reverend Rice was Presbyterian | Reverend John W. Rice Sr. (canonical Birmingham AL Presbyterian minister) | 0.0 | low-impact |
| `45.P3.3` | Pass 3 | "Connie / Kandy" → Condoleezza Rice childhood-nickname (Pass 1 #45.23) | confirmed via Pass 2 #45.P2.26 "Connie's father" cross-instance | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Lowndes County, Alabama | Lowndes County | 2 | 3 |
| ? | Booker T. Washington | Booker T. Washington | 2 | 2 |
...
|---|---|---|---|---|---|
| `45.P3.1` | "Polish-cluster" Whisper-error pattern (Hrabowski → Ravasque | cross-corpus catalog item | "Polish-cluster" Whisper-error pattern (Hrabowski → Ravasque | F-ext |  |
...
The annotations in the master MD's `### 45. Freeman A. Hrabowski III` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

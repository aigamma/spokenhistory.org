# Layer 5 fidelity findings — entry #24 Courtland Cox
...
|---|---|---|---|---:|---|
| `24.6` | Pass 1 | Mike Therwell | Mike Thelwell | 0.0 | low-impact |
| `24.37` | Pass 1 | Featherstone | Ralph Featherstone | 0.0 | low-impact |
| `24.P2.30` | Pass 2 | Project Awareness 1961 | Project Awareness (Howard NAG-organized lecture/debate series 1961) | 0.0 | low-impact |
| `24.P2.34` | Pass 2 | Sammy Younge Jr. (cross-corpus) | Sammy Younge Jr. | 0.0 | low-impact |
| `24.P2.39` | Pass 2 | Atlantic City compromise (Hubert Humphrey + Walter Mondale) | the 1964 Mississippi Freedom Democratic Party compromise | 0.0 | low-impact |
| `24.P2.42` | Pass 2 | Glen Echo Park | Glen Echo Park, MD | 0.0 | low-impact |
| `24.P3.2` | Pass 3 | "Bayard / Biden" → Bayard Rustin | Bayard Rustin | 0.0 | low-impact |
| `24.P3.5` | Pass 3 | "C. L.A. James / C. L. A. James" → C.L.R. James | C.L.R. James (Cyril Lionel Robert James) | 0.0 | low-impact |
| `24.P3.12` | Pass 3 | "Mr. Boyle / Bo Boyle / O'Boyle" → Archbishop Patrick O'Boyle | Archbishop Patrick A. O'Boyle | 0.0 | low-impact |
| `24.P4.18` | Pass 4 | "people like Rapsang" | H. Rap Brown | 0.0 | low-impact |
| `24.P4.25` | Pass 4 | "drum and spear bookstore on 14th and Fairmont Street" | Drum and Spear Bookstore, 1372 Fairmont St NW / later 2701 14th St NW | 0.0 | low-impact |
...
| ? | Mike Thelwell | Mike Thelwell | 2 | 3 |
| ? | John Hulett | John Hulett | 2 | 3 |
| ? | Colonel Hà Văn Lâu | Colonel Hà Văn Lâu | 2 | 3 |
| ? | Ahmed Sékou Touré | Ahmed Sékou Touré | 2 | 3 |
| ? | Ruby Sales | Ruleville, Mississippi | 2 | 2 |
| ? | Willie "Mukasa" Ricks | Willie Ricks (Mukasa Dada) | 2 | 2 |
| ? | Erskine | Erskine | 2 | 2 |
| ? | Frank M. Snowden Jr. (likely) | Frank M. Snowden Jr. (likely) | 2 | 2 |
| ? | Marvin Holloway / Anne Holloway | Marvin Holloway / Anne Holloway | 2 | 2 |
| ? | Barack Obama Sr. (possibly) | Barack Obama Sr. (possibly) | 2 | 2 |
| ? | President Julius Nyerere (of Tanzania) | President Julius Nyerere (of Tanzania) | 2 | 2 |
| ? | not directly in Cox raw | not directly in Cox raw | 2 | 2 |
...
|---|---|---|---|---|---|
| `24.25` | Colonel Haavan Lo | Colonel Ha Van Lau | Colonel Hà Văn Lâu (Vietnamese diplomat) | E-ext |  |
...
The annotations in the master MD's `### 24. Courtland Cox` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #20 Clarence B. Jones
...
|---|---|---|---|---:|---|
| `20.1` | Pass 1 | Cornwell's Heights, Pennsylvania | Cornwells Heights, Pennsylvania | 0.0 | low-impact |
| `20.28` | Pass 1 | Eleanor Roosevelt / Mrs. Roosevelt | Eleanor Roosevelt | 0.0 | low-impact |
| `20.36` | Pass 1 | Captain Midnight / Captain Marvel / Phantom / Roy Rogers / Dale Evans / Jean Arc | (Captain Midnight / Captain Marvel / Phantom / Roy Rogers / Dale Evans / Gene Au | 0.0 | low-impact |
| `20.P2.2` | Pass 2 | Cornwell's Heights, Pennsylvania | Cornwells Heights, Pennsylvania | 0.0 | low-impact |
| `20.P2.17` | Pass 2 | Ed Dudley | Edward R. Dudley | 0.0 | low-impact |
| `20.P2.18` | Pass 2 | Allerton houses Bronx | Allerton Avenue Houses (Bronx) | 0.0 | low-impact |
| `20.P2.25` | Pass 2 | Charles Bell at the V Lake Norton | Charles W. Norton + W. Warder Norton (W.W. Norton & Company) | 0.0 | low-impact |
| `20.P4.2` | Pass 4 | (Subject paragraph) "Drafted significant portions of King's 'I Have a Dream' spe | Co-drafted "I Have a Dream" (specifically the opening "promissory note" passage) | 0.0 | low-impact |
| `20.P4.3` | Pass 4 | (Subject paragraph) "Drafted significant portions of King's 'I Have a Dream' spe | (missing the SCLC general counsel role) | 0.0 | low-impact |
...
| ? | Daniel H. Krenge De Iongh | Daniel H. Krenge De Iongh | 2 | 2 |
| ? | Hendrik Verwoerd | Hendrik Verwoerd | 2 | 2 |
| ? | promissory note | promissory note | 2 | 2 |
...
|---|---|---|---|---|---|
| `20.24` | Damon (the Hawaii landowner family) / Fran Damon | Damon Estate (one of the Big Five Hawaii landowners) | Vernon Dahmer Sr. (Hattiesburg NAACP martyr; firebombed Jan  | E |  |
...
The annotations in the master MD's `### 20. Clarence B. Jones` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

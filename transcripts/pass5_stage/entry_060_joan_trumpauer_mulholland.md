# Layer 5 fidelity findings — entry #60 Joan Trumpauer Mulholland
...
|---|---|---|---|---:|---|
| `60.10` | Pass 1 | Bannockburn | Bannockburn (MD progressive-Jewish community) | 0.0 | low-impact |
| `60.20` | Pass 1 | Arens Borenskie's lab in the cellar | Dr. Ernst Borinski's lab | 0.0 | low-impact |
| `60.P2.16` | Pass 2 | Polly Allewis | Pearlena Lewis | 0.0 | low-impact |
| `60.P2.26` | Pass 2 | Benny Oliver | Benny G. Oliver | 0.0 | low-impact |
| `60.P2.34` | Pass 2 | Jeanette King | Jeannette King | 0.0 | low-impact |
| `60.P2.37` | Pass 2 | the Tugaloo 9 | the Tougaloo Nine | 0.0 | low-impact |
| `60.P2.38` | Pass 2 | Arens Borenskie's lab in the cellar | Dr. Ernst Borinski's lab | 0.0 | low-impact |
| `60.P4.11` | Pass 4 | Subject paragraph claim of "Quaker-influenced Presbyterian" | Presbyterian (not Quaker) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Ocoeenee (Georgia) | Ocoeenee (Georgia) | 2 | 2 |
| ? | Tom Gaither (likely) | Tom Gaither (likely) | 2 | 2 |
| ? | Memphis Norman / Pearlena Lewis / Lois Chaffey / Doris Erski | Memphis Norman / Pearlena Lewis / Lois Chaffey / Doris Erski | 2 | 2 |
...
The annotations in the master MD's `### 60. Joan Trumpauer Mulholland` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

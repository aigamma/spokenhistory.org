# Layer 5 fidelity findings — entry #55 Harold K. Brown
...
|---|---|---|---|---:|---|
| `55.P2.11` | Pass 2 | Maulana Karenga (US Organization founder) | Dr. Maulana Karenga (Ronald McKinley Everett) | 0.0 | low-impact |
| `55.P2.12` | Pass 2 | Donald Warden / Khalid al-Mansour (Afro-American Association leader) | Donald Warden / Khalid Abdullah Tariq al-Mansour | 0.0 | low-impact |
| `55.P2.23` | Pass 2 | the United Nations (a place to live for the new bride in San Diego) | the Y (YWCA/YMCA, San Diego) | 0.0 | low-impact |
| `55.P2.27` | Pass 2 | Yorkville (York, Pennsylvania) | York, Pennsylvania | 0.0 | low-impact |
| `55.P2.31` | Pass 2 | Tony Brown's Journal (PBS) | *Tony Brown's Journal* (PBS, 1968-2008) | 0.0 | low-impact |
| `55.P2.32` | Pass 2 | White Girl (Tony Brown anti-drug film) | *The White Girl* (1990 Tony Brown film) | 0.0 | low-impact |
| `55.P2.42` | Pass 2 | New Year (Brown was offered a job there, "I went to New Year") | New York | 0.0 | low-impact |
| `55.P3.7` | Pass 3 | Bonneville National Forest (Brown's basic training site) | Camp Gordon, Georgia | 0.0 | low-impact |
| `55.P4.1` | Pass 4 | knee girl / knee grows / Negroes (mixed Whisper rendering of "Negro / Negroes") | Negro / Negroes | 0.0 | low-impact |
| `55.P4.12` | Pass 4 | Yorkville (York, Pennsylvania) | York, Pennsylvania | 0.0 | low-impact |
| `55.P4.13` | Pass 4 | the e-girl | "as an enlisted man" / "as an E-1" | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Shreveport, Louisiana | Shreveport / Caddo Parish | 2 | 3 |
| ? | Cassandra Shea | Cassandra Shea | 2 | 2 |
...
The annotations in the master MD's `### 55. Harold K. Brown` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

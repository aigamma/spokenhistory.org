# Layer 5 fidelity findings — entry #102 Reverend Harry Blake
...
|---|---|---|---|---:|---|
| `102.15` | Pass 1 | Cluclux Klan | Ku Klux Klan | 0.0 | low-impact |
| `102.34` | Pass 1 | Cape Kennedy | Cape Kennedy (now Cape Canaveral) | 0.0 | low-impact |
| `102.P2.30` | Pass 2 | the World War II draft board | local draft board (WWII-era plantation deferment) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Shreveport / Caddo Parish | Shreveport / Caddo Parish | 2 | 3 |
| ? | Booker T. Washington High School | Booker T. Washington | 2 | 2 |
| ? | NOT in transcript — Subject paragraph fabrication | Florida Memorial College | 2 | 2 |
| ? | Shreveport / Caddo Parish | Shreveport / Caddo Parish | 2 | 2 |
...
The annotations in the master MD's `### 102. Reverend Harry Blake` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

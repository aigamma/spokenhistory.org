# Layer 5 fidelity findings — entry #8 Bill Russell
...
|---|---|---|---|---:|---|
| `8.13` | Pass 1 | USS Iowa / U of Iowa | University of Iowa | 0.0 | low-impact |
| `8.40` | Pass 1 | Brown vs. Board | Brown v. Board of Education | 0.0 | low-impact |
| `8.P2.4` | Pass 2 | Coon-Roe Louisiana | Monroe, Louisiana | 0.0 | low-impact |
| `8.P2.21` | Pass 2 | Bunchy Carter big guy from Bowling Green | Charles Share (Bowling Green center) | 0.0 | low-impact |
| `8.P2.22` | Pass 2 | Ed Magnone / Magnone | Ed Macauley | 0.0 | low-impact |
| `8.P2.25` | Pass 2 | Dolph Shades | Dolph Schayes | 0.0 | low-impact |
| `8.P2.28` | Pass 2 | McClellan High | McClymonds High School (Oakland CA) | 0.0 | low-impact |
| `8.P2.36` | Pass 2 | Westinghouse real commentary | Westinghouse radio commentary | 0.0 | low-impact |
| `8.P2.37` | Pass 2 | Jeff and Ebony | *Jet* and *Ebony* | 0.0 | low-impact |
| `8.P2.38` | Pass 2 | Stoke, a whole cry | Stokely Carmichael | 0.0 | low-impact |
| `8.P2.39` | Pass 2 | Whitney Young | Whitney M. Young Jr. | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Charles "Mr. Charlie" Russell (Sr.) | Charles "Mr. Charlie" Russell (Sr.) | 2 | 3 |
| ? | Isabel Wilkerson | Isabel Wilkerson | 2 | 2 |
| ? | *The Warmth of Other Suns* | *The Warmth of Other Suns* | 2 | 2 |
| ? | Jim Loscutoff ("Jungle Jim" Loscutoff) | Jim Loscutoff ("Jungle Jim" Loscutoff) | 2 | 2 |
| ? | Jim Loscutoff ("Jungle Jim" Loscutoff) | Jim Loscutoff ("Jungle Jim" Loscutoff) | 2 | 2 |
...
|---|---|---|---|---|---|
| `8.31` | McLean / McClellan / U.N. McLean | McClymonds (High School) | McLain / McLaurin, Mississippi | F |  |
...
The annotations in the master MD's `### 8. Bill Russell` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

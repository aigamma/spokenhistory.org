# Layer 5 fidelity findings — entry #90 Mildred Bond Roxborough
...
|---|---|---|---|---:|---|
| `90.2` | Pass 1 | Heywood County, Tennessee | Haywood County, Tennessee | 0.0 | low-impact |
| `90.18` | Pass 1 | Megar Evers | Medgar Evers | 0.0 | low-impact |
| `90.38` | Pass 1 | Mata Kai Johnson | Mordecai Wyatt Johnson | 0.0 | low-impact |
| `90.40` | Pass 1 | Charles Evers eventually became mayor of Philadelphia | Charles Evers eventually became mayor of Fayette (Mississippi) | 0.0 | low-impact |
| `90.42` | Pass 1 | Mound Bayou | Mound Bayou (Mississippi) | 0.0 | low-impact |
| `90.P2.8` | Pass 2 | "Charles Evers eventually became mayor of Philadelphia" | Charles Evers eventually became mayor of Fayette (Mississippi) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | (James) Forman (uncertain) | James Forman | 2 | 10 |
| ? | Gloster B. Current | Gloster B. Current | 3 | 4 |
| ? | Eleanor Roosevelt | Mrs. Eleanor Roosevelt | 2 | 3 |
| ? | Bob (Carter) | Bob Zellner | 2 | 3 |
| ? | Mordecai Wyatt Johnson | Mordecai Wyatt Johnson | 2 | 3 |
| ? | Mound Bayou, Mississippi | Mound Bayou (Hospital / Tufts-Delta Community Health Center) | 2 | 2 |
| ? | (Clarence) "Willie" Norris | (Clarence) "Willie" Norris | 2 | 2 |
| ? | Thurgood Marshall | Thurgood Marshall | 2 | 2 |
| ? | Parks Sausage Company | Parks Sausage Company | 2 | 2 |
| ? | Arthur L. Johnson (Detroit NAACP executive secretary) | Arthur L. Johnson (Detroit NAACP executive secretary) | 2 | 2 |
...
|---|---|---|---|---|---|
| `90.P2.36` | "Jose Williams" pattern check | n/a (not in this transcript) | Hosea Williams (SCLC) | C |  |
...
The annotations in the master MD's `### 90. Mildred Bond Roxborough` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

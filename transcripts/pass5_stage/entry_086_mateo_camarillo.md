# Layer 5 fidelity findings — entry #86 Mateo Camarillo
...
|---|---|---|---|---:|---|
| `86.22` | Pass 1 | Quintus Sol | Quinto Sol | 0.0 | low-impact |
| `86.P2.6` | Pass 2 | Mission San Diego de Alcalá | Mission San Diego de Alcalá (1769) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | confirming pattern | Crestwood, Illinois | 2 | 3 |
| ? | Chicano Park / Barrio Logan | Chicano Park / Barrio Logan | 2 | 2 |
| ? | Monsanto, Harvest at Sea (seaweed) | Monsanto, Harvest at Sea (seaweed) | 2 | 2 |
| ? | Des Moines, Iowa (Reagan radio context) | Des Moines, Iowa (Reagan radio context) | 2 | 2 |
| ? | confirming pattern | confirming pattern | 2 | 2 |
...
|---|---|---|---|---|---|
| `86.P3.9` | Recurring "David Klein" -> David Cline pattern | catalog-worthy | David Cline | A-ext |  |
...
The annotations in the master MD's `### 86. Mateo Camarillo` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

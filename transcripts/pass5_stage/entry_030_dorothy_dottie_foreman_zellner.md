# Layer 5 fidelity findings — entry #30 Dorothy "Dottie" Foreman Zellner
...
|---|---|---|---|---:|---|
| `30.12` | Pass 1 | Pam Stevens / Patricia Stevens / Priscilla Stevens | Patricia Stevens (Due) / Priscilla Stevens (Kruize) | 0.0 | low-impact |
| `30.38` | Pass 1 | Dinky Romley | Dinky Romilly (Constance "Dinky" Romilly) | 0.0 | low-impact |
| `30.P2T.49` | Pass 2 tail-sweep | Barney Frank told me to write it down immediately | Barney Frank | 0.0 | low-impact |
...
| ? | Dinky Forman (Constance "Dinky" Romilly Forman) | Dinky Romilly | 3 | 3 |
| ? | SNCC | SNCC | 3 | 3 |
| ? | Leslie Dunbar (SRC executive director) | Leslie W. Dunbar | 2 | 2 |
| ? | Angeline Butler | Angeline Butler | 2 | 2 |
...
|---|---|---|---|---|---|
| `30.17` | Father Fichter | Joseph Fichter (Rev. Joseph H. Fichter, SJ) | Joseph H. Fichter, SJ (Loyola NOLA sociologist) | E |  |
| `30.38` | Dinky Romley | Dinky Romilly (Constance "Dinky" Romilly) | Dinky Forman (Constance "Dinky" Romilly Forman) | C |  |
| `30.P2.2` | Brown vs. Borge | Brown v. Board of Education | not present in this transcript | E-ext |  |
| `30.P2T.2` | virtual wife (Constance "Dinky" Romilly Forman) | Constance "Dinky" Romilly (canonical Dinky Forman) | Dinky Forman (Constance "Dinky" Romilly Forman) | C |  |
| `30.P3.13` | "in extremists" (30.P2.3) → in extremis (Latin idiom) | high | in extremis (Latin idiom) | G |  |
| `30.P3.14` | "the Master Race" billboard (catalog G "the master is wearin | not in this transcript | "the master is wearing swastikers" | G-ext |  |
...
The annotations in the master MD's `### 30. Dorothy "Dottie" Foreman Zellner` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

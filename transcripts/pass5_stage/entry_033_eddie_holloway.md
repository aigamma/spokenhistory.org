# Layer 5 fidelity findings — entry #33 Eddie Holloway
...
|---|---|---|---|---:|---|
| `33.59` | Pass 1 | Ms. Branch (Gwendolyn Branch) | Gwendolyn Branch (Elaine's classmate) | 0.0 | low-impact |
| `33.60` | Pass 1 | Camp Shelby trained personnel | Camp Shelby (training facility) | 0.0 | low-impact |
| `33.P3.5` | Pass 3 | "Concerned Student 1950" / "Tim Wolfe" (context for Pass-2 #33.P2.9) | The 2015 Mizzou Concerned Student 1950 movement / UM System President Tim Wolfe | 0.0 | low-impact |
| `33.P3.6` | Pass 3 | "Frederick Herzberg" (Pass-2 #33.P2.2) | Cross-corpus backfile to catalog #E (already noted there) | 0.0 | low-impact |
...
| ? | Vernon Dahmer / Dahmer Hall / Dahmer's son | Vernon Dahmer / Dahmer Hall / Dahmer's son | 4 | 5 |
| ? | N.R. Burger (Dr. N.R. Burger) | N.R. Burger (Dr. N.R. Burger) | 3 | 4 |
| ? | Hattiesburg, Mississippi | Hattiesburg | 2 | 3 |
| ? | Clyde Kennard | Clyde Kennard | 2 | 3 |
| ? | Hattiesburg, Mississippi | Hattiesburg, Mississippi | 2 | 2 |
| ? | Hattiesburg, Mississippi | Hattiesburg, Mississippi | 2 | 2 |
...
The annotations in the master MD's `### 33. Eddie Holloway` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

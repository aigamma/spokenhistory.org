# Layer 5 fidelity findings — entry #22 Dr. Cleveland Sellers
...
|---|---|---|---|---:|---|
| `22.9` | Pass 1 | Wonderful T. Gibbs / Warmoth T. Gibbs | Warmoth T. Gibbs | 0.0 | low-impact |
| `22.12` | Pass 1 | Ruby Dyer's / Ruby Dyer's Robinson | Ruby Doris Smith Robinson | 0.0 | low-impact |
| `22.35` | Pass 1 | Bunchy Carter | Alprentice "Bunchy" Carter | 0.0 | low-impact |
| `22.38` | Pass 1 | the Marideth March | the Meredith March Against Fear (June 1966) | 0.0 | low-impact |
| `22.41` | Pass 1 | Peg Leg baits | Peg Leg Bates Country Club (Kerhonkson, NY) | 0.0 | low-impact |
| `22.49` | Pass 1 | Mr. Hewlett | John Hulett | 0.0 | low-impact |
| `22.P2.29` | Pass 2 | Jim Forman | James Forman | 0.0 | low-impact |
| `22.P2.31` | Pass 2 | Garo's book on King | *Bearing the Cross: Martin Luther King, Jr., and the Southern Christian Leadersh | 0.0 | low-impact |
| `22.P3.3` | Pass 3 | "Slave Sellers" → Cleve Sellers | Cleveland L. Sellers Jr. ("Cleve Sellers") | 0.0 | low-impact |
| `22.P3.5` | Pass 3 | "Stoke the Carmichael" → Stokely Carmichael | Stokely Carmichael (Kwame Ture) | 0.0 | low-impact |
...
| ? | Samuel Younge Jr. | Samuel Younge Jr. | 2 | 6 |
| ? | Hosea Williams | Hosea Williams | 2 | 4 |
| ? | Mike Thelwell | Mike Thelwell | 2 | 3 |
| ? | Dona Richards (Bob Moses's wife at the time) | Dona Richards (Bob Moses's wife at the time) | 3 | 3 |
| ? | John Hulett | John Hulett | 2 | 3 |
| ? | John Hatchett (likely) | John Hatchett (likely) | 2 | 2 |
| ? | Gwen Robinson (later Zoharah Simmons) | Gwen Robinson (later Zoharah Simmons) | 2 | 2 |
| ? | Holly Fries (or similar) | Holly Fries (or similar) | 2 | 2 |
| ? | (David) Garrow | (David) Garrow | 2 | 2 |
| ? | Matthew Jackson Sr. (likely) | Matthew Jackson Sr. (likely) | 2 | 2 |
| ? | Cleveland L. Sellers Jr. ("Cleve Sellers") | Cleveland L. Sellers Jr. ("Cleve Sellers") | 2 | 2 |
...
|---|---|---|---|---|---|
| `22.P3.3` | "Slave Sellers" → Cleve Sellers | Cleveland L. Sellers Jr. ("Cleve Sellers") | Cleve Sellers / Cleveland Sellers | C |  |
...
The annotations in the master MD's `### 22. Dr. Cleveland Sellers` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #131 Worth W. Long
...
|---|---|---|---|---:|---|
| `131.P2.36` | Pass 2 | he could say, preach it. ... I said, should I fill it up, preach it? | he could say, "Preacher." ... I said, "Should I fill it up, Preacher?" | 0.0 | low-impact |
| `131.P3.2` | Pass 3 | "Hayti → Hata / HATA" | Hayti (Durham NC Black community) | 0.0 | low-impact |
| `131.P3.3` | Pass 3 | "Booker T → Book of Tea" | Booker T Theater (Durham NC) | 0.0 | low-impact |
| `131.P3.6` | Pass 3 | "Lyceum program → last exam program" (recurring 3x in #131) | Lyceum program | 0.0 | low-impact |
| `131.P3.9` | Pass 3 | "AME Zion → Amizan" | AME Zion | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Bull City Drug Store (likely) / W.M. Rich's Bull City Drug | Bull City Drug Store (likely) / W.M. Rich's Bull City Drug | 2 | 2 |
| ? | North Carolina Central | North Carolina Central | 2 | 2 |
...
The annotations in the master MD's `### 131. Worth W. Long` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #91 Mildred Pitts Walter
...
|---|---|---|---|---:|---|
| `91.27` | Pass 1 | Mama St. Ellen | Mount St. Helens | 0.0 | low-impact |
| `91.P2.9` | Pass 2 | "Camp Polk in Leesville" | Camp Polk, Leesville (Louisiana) | 0.0 | low-impact |
| `91.P2.16` | Pass 2 | "Justin in the Best Biscuits in the World" | *Justin and the Best Biscuits in the World* (1986, Walter) | 0.0 | low-impact |
| `91.P2.38` | Pass 2 | "Susan Chavez" pattern check | César Chávez | 0.0 | low-impact |
| `91.P2.41` | Pass 2 | "Democratic National Convention in Atlantic City" 1964 | Atlantic City, NJ 1964 DNC | 0.0 | low-impact |
| `91.P2.47` | Pass 2 | "Greensboro Truth and Reconciliation Commission" 2004-06 + "Greensboro Massacre" | Greensboro Massacre November 3, 1979 + Greensboro Truth and Reconciliation Commi | 0.0 | low-impact |
| `91.P3.1` | Pass 3 | "Mama St. Ellen" (recurring Mount St. Helens degradation) | Mount St. Helens | 0.0 | low-impact |
| `91.P3.6` | Pass 3 | "Scotlandville -> Scotland, Bill" pattern | Scotlandville (Louisiana, Southern University HBCU site) | 0.0 | low-impact |
...
| ? | Toussaint Louverture | Toussaint Louverture | 2 | 3 |
| ? | Jesse M. Unruh | Jesse M. Unruh | 2 | 2 |
...
The annotations in the master MD's `### 91. Mildred Pitts Walter` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

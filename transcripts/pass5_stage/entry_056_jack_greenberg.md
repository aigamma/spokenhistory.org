# Layer 5 fidelity findings — entry #56 Jack Greenberg
...
|---|---|---|---|---:|---|
| `56.P2.38` | Pass 2 | Swann decision (1971) | *Swann v. Charlotte-Mecklenburg Board of Education* (1971) | 0.0 | low-impact |
...
| ? | Marshal Foch (likely) | Marshal Foch (likely) | 2 | 2 |
| ? | Marshal Foch | Marshal Foch | 2 | 2 |
| ? | the writ of certiorari (statutory) vs. ancient common-law ce | the writ of certiorari (statutory) vs. ancient common-law ce | 2 | 2 |
...
The annotations in the master MD's `### 56. Jack Greenberg` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

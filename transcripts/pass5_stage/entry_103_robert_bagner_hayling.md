# Layer 5 fidelity findings — entry #103 Robert Bagner Hayling
...
|---|---|---|---|---:|---|
| `103.26` | Pass 1 | mega-evils | Medgar Evers | 0.0 | low-impact |
| `103.P2.4` | Pass 2 | Sheepshead Bay restaurant | Sheepshead Bay (Brooklyn) | 0.0 | low-impact |
| `103.P2.34` | Pass 2 | rights and privileges restored (re Hoss Manucy) | civil rights restoration after federal felony moonshining conviction | 0.0 | low-impact |
| `103.P2.37` | Pass 2 | NAACP charter mail-back / Wilkins fired NAACP (canonical Mrs. Hawthong special d | Late 1963 NAACP charter renunciation | 0.0 | low-impact |
| `103.P2.47` | Pass 2 | mountainous mortician (re Mr. Chase) | (likely) E.G. Chase + Chase Mortuary | 0.0 | low-impact |
...
| ? | Mrs. Burgess / Mrs. Rowe / Mrs. Campbell | Miss Emma Campbell | 3 | 3 |
| ? | Lyndon (B.) Johnson | Lyndon Johnson | 2 | 2 |
| ? | Tennessee A&I (State University) / Tennessee State Universit | Tennessee A&I (State University) / Tennessee State Universit | 2 | 2 |
| ? | Clyde Jenkins | Clyde Jenkins | 2 | 2 |
| ? | Mrs. Burgess / Mrs. Rowe / Mrs. Campbell | Mrs. Burgess / Mrs. Rowe / Mrs. Campbell | 2 | 2 |
| ? | Mrs. Burgess / Mrs. Rowe / Mrs. Campbell | Mrs. Burgess / Mrs. Rowe / Mrs. Campbell | 2 | 2 |
| ? | Yale (College) cum laude / Crystal | Yale (College) cum laude / Crystal | 2 | 2 |
| ? | Yale (College) cum laude / Crystal | Yale (College) cum laude / Crystal | 2 | 2 |
| ? | Roman / Avery | Roman / Avery | 2 | 2 |
| ? | Mr. Pendman / Pendman's Restaurant | Mr. Pendman / Pendman's Restaurant | 2 | 2 |
| ? | ACCORD (Anniversary to Commemorate the Civil Rights Demonstr | ACCORD (Anniversary to Commemorate the Civil Rights Demonstr | 2 | 2 |
...
The annotations in the master MD's `### 103. Robert Bagner Hayling` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

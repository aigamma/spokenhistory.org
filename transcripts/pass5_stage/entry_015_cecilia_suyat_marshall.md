# Layer 5 fidelity findings — entry #15 Cecilia Suyat Marshall
...
|---|---|---|---|---:|---|
| `15.3` | Pass 1 | Royal Wilkins | Roy Wilkins | 0.0 | low-impact |
| `15.21` | Pass 1 | 409 Edgecombe / 409 H | 409 Edgecombe Avenue | 0.0 | low-impact |
| `15.30` | Pass 1 | NAACP Legal Defense Fund | NAACP Legal Defense and Educational Fund | 0.0 | low-impact |
| `15.P3.2` | Pass 3 | "Sirgood / Theragos / Sirgood Marshal" → "Thurgood Marshall" | Thurgood Marshall | 0.0 | low-impact |
| `15.P3.3` | Pass 3 | NAACP National Office (NYC, 20 West 40th Street → later 1790 Broadway) | NAACP National Headquarters | 0.0 | low-impact |
| `15.P3.4` | Pass 3 | "NAACP Legal Defense Fund" carefully distinguished from "NAACP organization" | LDF (1957 spinoff) vs NAACP parent organization | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | John W. Marshall | John W. Walker | 4 | 4 |
| ? | Gloster B. Current | Gloster B. Current | 3 | 4 |
| ? | Robert L. Carter | Robert L. Carter | 2 | 3 |
| ? | Louis Jefferson | Louis Jefferson | 2 | 2 |
| ? | Thurgood | Thurgood | 2 | 2 |
| ? | Travelers Aid | Travelers Aid | 2 | 2 |
...
The annotations in the master MD's `### 15. Cecilia Suyat Marshall` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

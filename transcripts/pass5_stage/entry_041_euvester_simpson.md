# Layer 5 fidelity findings — entry #41 Euvester Simpson
...
|---|---|---|---|---:|---|
| `41.29` | Pass 1 | Mrs. Lillierre's / Mrs. Ayre's / Jake Ayre's | Lillie Ayers / Jake Ayers | 0.0 | low-impact |
| `41.31` | Pass 1 | Cleveland MacDonald | Cleve McDowell | 0.0 | low-impact |
| `41.P2.8` | Pass 2 | Voice of Calvary health clinic in Mendenhall | Voice of Calvary health clinic, Mendenhall, Mississippi | 0.0 | low-impact |
| `41.P2.16` | Pass 2 | Lillie Ayers (recurring) | Lillie Ayers | 0.0 | low-impact |
| `41.P3.1` | Pass 3 | "Snick / sneak / snake" SNCC patterns | SNCC (Student Nonviolent Coordinating Committee) | 0.0 | low-impact |
| `41.P3.6` | Pass 3 | "*Local People* by John Dittmer 1994" | *Local People: The Struggle for Civil Rights in Mississippi* (Dittmer, Univ. of  | 0.0 | low-impact |
| `41.P3.8` | Pass 3 | "Marimba Ani" -> later name of Dona Richards | Marimba Ani | 0.0 | low-impact |
| `41.P4.18` | Pass 4 | "to attend two balloon arms" | to attend Tougaloo | 0.0 | low-impact |
...
| ? | Dona Richards Moses (later Marimba Ani) | Dona Richards (Bob Moses's wife at the time) | 3 | 3 |
| ? | Michael "Mickey" Schwerner | Michael "Mickey" Schwerner | 3 | 3 |
...
|---|---|---|---|---|---|
| `41.21` | Mickey / Michael Swarna | Michael "Mickey" Schwerner | Mickey Schwerner | G |  |
...
The annotations in the master MD's `### 41. Euvester Simpson` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

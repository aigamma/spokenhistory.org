# Layer 5 fidelity findings — entry #48 Gloria Claudette Grinnell
...
|---|---|---|---|---:|---|
| `48.5` | Pass 1 | 34 students | Richmond 34 | 0.0 | low-impact |
| `48.P2.13` | Pass 2 | the Presidio (public school) | Presidio (SF public school) | 0.0 | low-impact |
| `48.P2.17` | Pass 2 | Lift Every Voice and Sing (the black national anthem) | "Lift Every Voice and Sing" | 0.0 | low-impact |
| `48.P2.30` | Pass 2 | Brown vs. Borge | Brown v. Board of Education (1954) | 0.0 | low-impact |
| `48.P2.38` | Pass 2 | Charles Sherrod cross-reference | Charles Sherrod (transcript #18 in this corpus) | 0.0 | low-impact |
| `48.P2.39` | Pass 2 | not all 34 (Virginia Union students arrested) | the Richmond 34 (Virginia Union and Virginia Commonwealth students arrested at T | 0.0 | low-impact |
| `48.P3.5` | Pass 3 | "Lift Every Voice and Sing" canonical James Weldon Johnson Black national anthem | speaker-originating + canonical | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Adam Clayton Powell | Adam Clayton Powell | 3 | 3 |
| ? | *The Negro Motorist Green Book* | *The Negro Motorist Green Book* | 2 | 3 |
| ? | Thalhimer's (department store) | Thalhimer's (department store) | 2 | 2 |
| ? | the Western Addition / Fillmore (San Francisco neighborhood) | the Western Addition / Fillmore (San Francisco neighborhood) | 2 | 2 |
...
|---|---|---|---|---|---|
| `48.P3.1` | "Tolheimer's" → Thalhimer's department store | catalog category H Special Patterns entry candidate | "Tolheimer's" → Thalhimer's department store | F-ext |  |
| `48.P3.2` | "Adam Plicken-Paul" → Adam Clayton Powell Jr. cross-corpus | catalog category E entry needed | "Adam Plicken-Paul" → Adam Clayton Powell Jr. cross-corpus | C-ext |  |
| `48.P3.4` | "the West in" → Western Addition (SF) | catalog category F entry needed | "the West in" → Western Addition (SF) | F-ext |  |
...
The annotations in the master MD's `### 48. Gloria Claudette Grinnell` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #87 Matthew J. Perry Jr.
...
|---|---|---|---|---:|---|
| `87.25` | Pass 1 | NAACP Legal Defense Fund + NAACP General Counsel | NAACP-LDF (Inc. Fund) + NAACP Office of General Counsel | 0.0 | low-impact |
| `87.P2.28` | Pass 2 | the Italian POW (Birmingham AL train terminal 1943) | Italian prisoners of war (canonical WWII US POW camps) | 0.0 | low-impact |
...
| ? | John Wrighten | John Wrighten | 2 | 2 |
| ? | *Sweatt v. Painter* (1950) and *McLaurin v. Oklahoma State R | *Sweatt v. Painter* (1950) and *McLaurin v. Oklahoma State R | 2 | 2 |
...
The annotations in the master MD's `### 87. Matthew J. Perry Jr.` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #118 Steven McNichols
...
| D2 — Bidirectional canonical inconsistencies | 6 (cluster participations) |
...
|---|---|---|---|---:|---|
| `118.49` | Pass 1 | Lyndon B. Johnson / LBJ | Lyndon B. Johnson | 0.0 | low-impact |
| `118.P2.27` | Pass 2 | the helms | Richard Helms | 0.0 | low-impact |
| `118.P2.34` | Pass 2 | LBJ Voting Rights Act White House signing ceremony | August 6, 1965 Voting Rights Act White House signing ceremony | 0.0 | low-impact |
| `118.P2.39` | Pass 2 | National Lawyers Guild (NLG) | National Lawyers Guild | 0.0 | low-impact |
| `118.P2.45` | Pass 2 | $38,000 raised (Thanksgiving Fast) | $38,000 (1964 Thanksgiving Fast for Freedom) | 0.0 | low-impact |
| `118.P3.3` | Pass 3 | "Schwerner → Schwannum" | Add to catalog | 0.0 | low-impact |
| `118.P3.4` | Pass 3 | "Connally → Connolly" Whisper homophone | Standard Whisper-homophone pattern | 0.0 | low-impact |
| `118.P3.5` | Pass 3 | "Reuther → Ruzer" Whisper rendering | Add to catalog | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | (probably) Tunica County (MS) | (probably) Tunica County (MS) | 2 | 2 |
| ? | (probably) Tim Jenkins | (probably) Tim Jenkins | 2 | 2 |
| ? | MFDP (Mississippi Freedom Democratic Party) | MFDP (Mississippi Freedom Democratic Party) | 2 | 2 |
...
|---|---|---|---|---|---|
| `118.P2.50` | LEMFDP | MFDP (Mississippi Freedom Democratic Party) | Whisper rendering "L" intrusion before acronyms | B-ext |  |
| `118.P3.2` | "snake" → SNCC pattern reinforcement | Cross-corpus catalog match | SNCC (Student Nonviolent Coordinating Committee) | B |  |
...
The annotations in the master MD's `### 118. Steven McNichols` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

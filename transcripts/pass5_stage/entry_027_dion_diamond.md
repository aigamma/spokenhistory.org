# Layer 5 fidelity findings — entry #27 Dion Diamond
...
|---|---|---|---|---:|---|
| `27.P2.1` | Pass 2 | Lake Pontchar Train Bridge | Lake Pontchartrain Causeway | 0.0 | low-impact |
| `27.P2.5` | Pass 2 | Cherry Deal Drug Fair (Alexandria) | Cherrydale Drug Fair (Arlington VA) | 0.0 | low-impact |
| `27.P2.16` | Pass 2 | Charleston church shooting | Charleston, SC AME Emanuel Church shooting (June 17, 2015) | 0.0 | low-impact |
| `27.P2.17` | Pass 2 | Glen Echo Park | Glen Echo Park, MD | 0.0 | low-impact |
| `27.P2.26` | Pass 2 | NSA Congress Columbus Ohio 1963 | National Student Association Congress (Columbus OH 1963) | 0.0 | low-impact |
| `27.P3.2` | Pass 3 | "the Bobby Kennedy / Mississippi Governor deal" | Robert F. Kennedy (AG) and Mississippi Gov. Ross Barnett's tacit arrest-not-viol | 0.0 | low-impact |
| `27.P3.3` | Pass 3 | "the changing-of-the-guard at the Alabama-Mississippi state line" (Pass 1 note) | National Guard escort handoff to Mississippi state police, late May 1961 Freedom | 0.0 | low-impact |
| `27.P3.4` | Pass 3 | Sammy Younge Jr. (27.P2.23 listed as "not directly named") | confirmed not in Diamond's narrative | 0.0 | low-impact |
| `27.P3.5` | Pass 3 | "Pikky Pia (?) / Pike County" (27.P2.25) | Pike County, Mississippi | 0.0 | low-impact |
| `27.P3.6` | Pass 3 | "Charleston (church shooting)" (Diamond's December 2015 contemporary reference) | Charleston AME Emanuel Church shooting, June 17, 2015 | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Glen Echo Park | Glen Echo Park | 2 | 2 |
...
The annotations in the master MD's `### 27. Dion Diamond` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #43 Frankye Adams-Johnson
...
|---|---|---|---|---:|---|
| `43.14` | Pass 1 | Megars / mega-ever's | Medgar Evers | 0.0 | low-impact |
| `43.18` | Pass 1 | Dr. Berenc ski | Dr. Ernst Borinski | 0.0 | low-impact |
| `43.21` | Pass 1 | Jackson Fairgrounds | Mississippi State Fairgrounds | 0.0 | low-impact |
| `43.P2.3` | Pass 2 | Hollis version | Hollis Watkins | 0.0 | low-impact |
...
| ? | Whisper substitution for Chicanos / Black radicals (per #47. | Whisper substitution for Chicanos / Black radicals (per #47. | 3 | 3 |
| ? | Benjamin Brown | Benjamin Brown | 2 | 2 |
...
The annotations in the master MD's `### 43. Frankye Adams-Johnson` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

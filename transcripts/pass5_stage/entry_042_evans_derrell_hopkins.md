# Layer 5 fidelity findings — entry #42 Evans Derrell Hopkins
...
|---|---|---|---|---:|---|
| `42.P2.8` | Pass 2 | Cle Sloan | Cle "Bone" Sloan | 0.0 | low-impact |
| `42.P2.9` | Pass 2 | Huey Newton 1971 reformulation | Huey Newton's 1971 theoretical reformulation (put away the gun) | 0.0 | low-impact |
| `42.P3.1` | Pass 3 | "COINTELPRO" at Winston-Salem State University | COINTELPRO (FBI Counterintelligence Program) | 0.0 | low-impact |
| `42.P3.2` | Pass 3 | "Bobby Seale's 1973 Oakland mayoral campaign" | Bobby Seale-for-Mayor 1973 | 0.0 | low-impact |
| `42.P3.4` | Pass 3 | "Huey P. Newton" canonical naming | Huey Percy Newton (1942-89) | 0.0 | low-impact |
| `42.P3.5` | Pass 3 | "Robert F. Williams" reference if present | Robert F. Williams (*Negroes with Guns* 1962) | 0.0 | low-impact |
...
| ? | Sons of Malcolm (original proposed BPP name 1966) | Catalog gaps | 3 | 3 |
...
The annotations in the master MD's `### 42. Evans Derrell Hopkins` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

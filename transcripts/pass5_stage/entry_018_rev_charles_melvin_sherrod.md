# Layer 5 fidelity findings — entry #18 Rev. Charles Melvin Sherrod
...
|---|---|---|---|---:|---|
| `18.12` | Pass 1 | Sumter County | Sumter County, Georgia | 0.0 | low-impact |
| `18.14` | Pass 1 | Daudi County | Dougherty County, Georgia | 0.0 | low-impact |
| `18.P2.1` | Pass 2 | Shaw Baptist Church | Shiloh Baptist Church (Albany GA) | 0.0 | low-impact |
| `18.P2.5` | Pass 2 | Police Chief Pritchett | Police Chief Laurie Pritchett | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Terrell County, Georgia | Terrell County, Georgia | 2 | 4 |
| ? | Americus, Georgia | Americus, Georgia | 2 | 3 |
...
The annotations in the master MD's `### 18. Rev. Charles Melvin Sherrod` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #128 William Lucy
...
|---|---|---|---|---:|---|
| `128.P2.38` | Pass 2 | the National Press came with Dr. King | (King's traveling national press corps) | 0.0 | low-impact |
| `128.P2.64` | Pass 2 | Hubert Humphrey (1972 election context) | Hubert Humphrey | 0.0 | low-impact |
| `128.P3.2` | Pass 3 | "Memphis Auditation Strike -> Memphis Sanitation Strike" pattern | Memphis Sanitation Strike | 0.0 | low-impact |
| `128.P3.3` | Pass 3 | "Ruffamon Hotel -> Rivermont Hotel" pattern | Rivermont Hotel | 0.0 | low-impact |
| `128.P3.4` | Pass 3 | "Marillo / Mayor Loeb" (128.P2.31) | Mayor Loeb | 0.0 | low-impact |
| `128.P4.10` | Pass 4 | "Big six" / six leaders of the civil rights movement (any reference) | (none — Lucy does not invoke the canonical "Big Six" framing in this interview) | 0.0 | low-impact |
...
| ? | Gallo (E. & J. Gallo Winery) | Gallo (E. & J. Gallo Winery) | 2 | 2 |
| ? | Clayborn Temple AME Church | Clayborn Temple AME Church | 2 | 2 |
| ? | Abe Plough / Plough, Inc. | Abe Plough / Plough, Inc. | 2 | 2 |
| ? | Lewis Donelson (Memphis City Council) | Lewis Donelson (Memphis City Council) | 2 | 2 |
| ? | Mayor (Henry) Loeb | Mayor (Henry) Loeb | 2 | 2 |
...
The annotations in the master MD's `### 128. William Lucy` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

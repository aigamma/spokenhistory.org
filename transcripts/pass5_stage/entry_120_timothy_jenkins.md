# Layer 5 fidelity findings — entry #120 Timothy Jenkins
...
|---|---|---|---|---:|---|
| `120.38` | Pass 1 | Madge of Evers | Medgar Evers | 0.0 | low-impact |
| `120.39` | Pass 1 | Stop in the name of Medgar | "Stop in the name of Medgar" | 0.0 | low-impact |
| `120.P2.45` | Pass 2 | "the food trucks" / Dick Gregory food airlift | Dick Gregory food-airlift to Mississippi (1962-63) | 0.0 | low-impact |
| `120.P2.60` | Pass 2 | Postal Service governing board | US Postal Service Board of Governors | 0.0 | low-impact |
| `120.P2.61` | Pass 2 | Woodrow Wilson postal segregation | Woodrow Wilson's 1913 federal-workforce racial segregation | 0.0 | low-impact |
| `120.P2.80` | Pass 2 | the WCC student walk-out | Southern schools' walk-out (NSA over sit-in resolutions) | 0.0 | low-impact |
| `120.P2.81` | Pass 2 | the Cumberland Mountains accident | the August 1961 Highlander-to-Chattanooga truck-attack incident | 0.0 | low-impact |
| `120.P2.85` | Pass 2 | Three Charleses + Jenkins | the "Three Charleses + Jenkins" SNCC delegation | 0.0 | low-impact |
| `120.P2.88` | Pass 2 | the Atlanta sit-in demonstration | the Atlanta sit-in mass meeting (Oct 1960) | 0.0 | low-impact |
| `120.P3.8` | Pass 3 | "L-intrusion before MFDP" cross-corpus pattern | Reinforces #118.P3.1 | 0.0 | low-impact |
| `120.P3.10` | Pass 3 | "Stop in the name of Medgar" canonical-phrase confirmation | Reinforces Pass 1 #120.39 | 0.0 | low-impact |
| `120.P3.11` | Pass 3 | Cross-corpus "Three Charleses + Jenkins" delegation | New canonical-delegation name | 0.0 | low-impact |
...
| ? | Judge William Harold Cox | Judge W. Harold Cox (William Harold Cox) | 2 | 3 |
| ? | Robert F. Kennedy's 1960 Coretta King phone call (not telegr | correct | 3 | 3 |
...
|---|---|---|---|---|---|
| `120.P3.1` | "Mary and Barry" → Marion Barry pattern | New canonical-alias rendering | "Mary and Barry" → Marion Barry pattern | C-ext |  |
| `120.P3.3` | "Caravan" → Carawan pattern | Cross-corpus catalog addition | "Caravan" → Carawan pattern | O-ext |  |
| `120.P3.6` | "Kappa Hosek" → Capahosic pattern | New canonical-alias rendering | "Kappa Hosek" → Capahosic pattern | K-ext |  |
| `120.P3.7` | "Pauline Murray" → Pauli Murray pattern | New canonical-alias rendering | "Pauline Murray" → Pauli Murray pattern | C-ext |  |
| `120.P3.9` | "Mary and Barry" + "Stokeley" + "gold water" + "theater of t | Whisper-degradation severity pattern | "Mary and Barry" → Marion Barry pattern | C-ext |  |
| `120.P4.4` | "Stokely Carmichael" / "soakly Carmichael" / "Stokeley Carmi | Stokely Carmichael (Kwame Ture) | Kwame Ture (1941-98) | C-ext |  |
...
The annotations in the master MD's `### 120. Timothy Jenkins` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

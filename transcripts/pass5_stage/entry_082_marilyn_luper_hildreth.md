# Layer 5 fidelity findings — entry #82 Marilyn Luper Hildreth
...
|---|---|---|---|---:|---|
| `82.20` | Pass 1 | Donglee | Dunjee | 0.0 | low-impact |
| `82.P2.29` | Pass 2 | Marsha Field Foundation (NOT in this transcript) | Marshall Field Foundation | 0.0 | low-impact |
| `82.P3.9` | Pass 3 | The "first-in-US-history" framing (P2 notes) | (canonical Movement-history claim) | 0.0 | low-impact |
...
| ? | *Brother President* (play) | *Brother President* (play) | 2 | 3 |
| ? | Marilyn (née Calvin) Luper Hildreth | Marilyn (née Calvin) Luper Hildreth | 2 | 2 |
| ? | Martin Luther King Jr. / *Brother President* | Martin Luther King Jr. / *Brother President* | 2 | 2 |
| ? | Clara Luper | Clara Luper | 2 | 2 |
| ? | Clara Luper | Clara Luper | 2 | 2 |
| ? | Barbara Posey (Jones) — University of Georgia professor (or  | Barbara Posey (Jones) — University of Georgia professor (or  | 2 | 2 |
| ? | Barbara Posey (Jones) — University of Georgia professor (or  | Barbara Posey (Jones) — University of Georgia professor (or  | 2 | 2 |
| ? | "Tokyo and Marilyn I said" (?) | "Tokyo and Marilyn I said" (?) | 2 | 2 |
| ? | Dunjee | Dunjee | 2 | 2 |
| ? | Joe Mosnier of the Southern Oral History Program | Joe Mosnier of the Southern Oral History Program | 2 | 2 |
...
The annotations in the master MD's `### 82. Marilyn Luper Hildreth` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

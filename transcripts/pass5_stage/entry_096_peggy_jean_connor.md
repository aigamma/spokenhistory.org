# Layer 5 fidelity findings — entry #96 Peggy Jean Connor
...
|---|---|---|---|---:|---|
| `96.15` | Pass 1 | Mr. Damer / Vernon Damer | Vernon Dahmer | 0.0 | low-impact |
| `96.21` | Pass 1 | Bill Kunstler | William Kunstler | 0.0 | low-impact |
| `96.P2.18` | Pass 2 | Stace White / Stacey White | Stacey White | 0.0 | low-impact |
...
| ? | Joyce (Connor's sister) | Joyce Ladner | 3 | 3 |
| ? | (drinking dipper) / [no WATS line ref] | the WATS line (Wide Area Telephone Service line) | 2 | 3 |
| ? | Vernon Dahmer | Vernon Dahmer | 2 | 3 |
| ? | Prathia Hall / Doug Smith / (Doris?) Bailey | Prathia Hall / Doug Smith / (Doris?) Bailey | 2 | 3 |
| ? | Felicia (Connor) | Felicia (Connor) | 2 | 2 |
| ? | Brown decision / Governor (Hugh) White / Committee of 100 | Brown decision / Governor (Hugh) White / Committee of 100 | 2 | 2 |
...
|---|---|---|---|---|---|
| `96.P2.48` | the watch line / dipper and water | (drinking dipper) / [no WATS line ref] | the WATS line (Wide Area Telephone Service; 1960s SNCC infra | G |  |
...
The annotations in the master MD's `### 96. Peggy Jean Connor` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

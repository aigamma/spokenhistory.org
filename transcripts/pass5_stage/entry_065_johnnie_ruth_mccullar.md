# Layer 5 fidelity findings — entry #65 Johnnie Ruth McCullar
...
|---|---|---|---|---:|---|
| `65.P3.2` | Pass 3 | "snake / snake workers" cross-reference to Henderson #68 same iteration | SNCC / SNCC workers | 0.0 | low-impact |
| `65.P4.30` | Pass 4 | brother of Clifford Brawner | sister of Clifford Brawner | 0.0 | low-impact |
...
| ? | Petna Dadelica (videographer; spelling unverified) | Pete Daniel (likely) | 3 | 4 |
...
The annotations in the master MD's `### 65. Johnnie Ruth McCullar` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

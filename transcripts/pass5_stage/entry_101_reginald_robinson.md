# Layer 5 fidelity findings — entry #101 Reginald Robinson
...
|---|---|---|---|---:|---|
| `101.P3.1` | Pass 3 | "Hank Thomas → Henry James Thomas" annotation | Canonical full name verification | 0.0 | low-impact |
...
| ? | Pop Herb St. Clair | Pop Herb | 2 | 4 |
| ? | Angela Butler | Angeline Butler | 2 | 2 |
| ? | Bobby Yancey (likely) | Bobbi Yancy (Roberta Y. "Bobbi" Yancy) | 2 | 2 |
| ? | Wyatt Tee Walker | Wyatt T. Walker | 2 | 2 |
| ? | Parks Sausage Co. | Parks Sausage Company | 2 | 2 |
| ? | Gwen (Robinson) Green | Gwen (Robinson) Green | 2 | 2 |
...
The annotations in the master MD's `### 101. Reginald Robinson` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

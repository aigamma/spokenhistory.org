# Layer 5 fidelity findings — entry #51 Gwendolyn Annette Perkins Duncan
...
|---|---|---|---|---:|---|
| `51.P2.27` | Pass 2 | the doctor's office strait hallway | the doctor's office straight hallway | 0.0 | low-impact |
| `51.P2.32` | Pass 2 | the joining Anderson | JoeAnn Anderson Ulmer | 0.0 | low-impact |
| `51.P2.50` | Pass 2 | the Medagascar | Madagascar | 0.0 | low-impact |
| `51.P3.3` | Pass 3 | "the cross-burning era" / KKK-night-marches | KKK night marches through Lincolnville (1963-65) | 0.0 | low-impact |
| `51.P3.4` | Pass 3 | "the NAACP / NCAP" cross-corpus variant in Duncan | NAACP | 0.0 | low-impact |
| `51.P3.5` | Pass 3 | "Andrew Young, Ambassador Young, Ambassador Andrew Young" recurring | Andrew Young | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Saint Augustine, Florida | Saint Augustine, Florida | 2 | 3 |
| ? | Jane Billings of Brown University / Spelman College | Jane Billings of Brown University / Spelman College | 3 | 3 |
| ? | Northrop Grumman / Northrop Grumman Corporation | Northrop Grumman / Northrop Grumman Corporation | 2 | 2 |
| ? | Northrop Grumman / Northrop Grumman Corporation | Northrop Grumman / Northrop Grumman Corporation | 2 | 2 |
| ? | Fairchild Hiller (likely) or (uncertain previous corporation | Fairchild Hiller (likely) or (uncertain previous corporation | 2 | 2 |
| ? | Excelsior | Excelsior | 2 | 2 |
| ? | Lillian Twine Robeson (or similar Twine family member) | Lillian Twine Robeson (or similar Twine family member) | 2 | 2 |
...
The annotations in the master MD's `### 51. Gwendolyn Annette Perkins Duncan` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #39 Ernest Adolphus Finney Jr.
...
|---|---|---|---|---:|---|
| `39.28` | Pass 1 | Orangeburg Massacre (Feb 8, 1968) | Orangeburg Massacre | 0.0 | low-impact |
| `39.P2.7` | Pass 2 | Friendship Nine 'jail no bail' tactic | "jail, no bail" tactic (Friendship Nine, January 31, 1961) | 0.0 | low-impact |
| `39.P2.9` | Pass 2 | the cadre of good lawyers, most of whom graduated from South Carolina State's la | SC State Law School Class graduates (1948–66 era) | 0.0 | low-impact |
| `39.P3.1` | Pass 3 | "the Rosa Parks bus boycott" reference | Montgomery Bus Boycott | 0.0 | low-impact |
| `39.P3.3` | Pass 3 | "Brown v. Board" timeline anchor | Brown v. Board of Education (May 17, 1954) | 0.0 | low-impact |
| `39.P3.4` | Pass 3 | "Henry Smith / Samuel Hammond / Delano Middleton" (Orangeburg Massacre victims) | Henry Smith, Samuel Hammond, Delano Middleton | 0.0 | low-impact |
| `39.P3.7` | Pass 3 | "Richard W. Riley" full name | Richard Wilson Riley | 0.0 | low-impact |
...
|---|---|---|---|---|---|
| `39.P3.6` | "Bobby Kennedy" -> Robert F. Kennedy | correct | Robert F. Kennedy | E |  |
...
The annotations in the master MD's `### 39. Ernest Adolphus Finney Jr.` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #61 John and Jean Rosenberg
...
|---|---|---|---|---:|---|
| `61.14` | Pass 1 | Charles Atlas case | Charles Atlas case (Louisiana 1959-60) | 0.0 | low-impact |
| `61.15` | Pass 1 | C.B. King (Albany GA) | C.B. King | 0.0 | low-impact |
| `61.21` | Pass 1 | Hodding Carter | Hodding Carter Jr. / Hodding Carter III | 0.0 | low-impact |
| `61.22` | Pass 1 | Killen | Edgar Ray "Preacher" Killen | 0.0 | low-impact |
| `61.24` | Pass 1 | Judge Frank Johnson | Judge Frank M. Johnson Jr. | 0.0 | low-impact |
| `61.P2.37` | Pass 2 | Hodding Carter | Hodding Carter Jr. / Hodding Carter III | 0.0 | low-impact |
| `61.P2.38` | Pass 2 | Judge Frank Johnson | Judge Frank M. Johnson Jr. | 0.0 | low-impact |
| `61.P2.45` | Pass 2 | C.B. King (Albany GA) | C.B. King / Chevene Bowers King | 0.0 | low-impact |
| `61.P2.49` | Pass 2 | Killen | Edgar Ray "Preacher" Killen | 0.0 | low-impact |
| `61.P2.65` | Pass 2 | Bunchy Carter | Alprentice "Bunchy" Carter | 0.0 | low-impact |
| `61.P2.70` | Pass 2 | Aaron Henry | Aaron E. Henry | 0.0 | low-impact |
| `61.P2.72` | Pass 2 | Brown versus Board / Brown versus board | *Brown v. Board of Education* (1954) | 0.0 | low-impact |
| `61.P2.74` | Pass 2 | Hamid Kessebosch | (cross-ref to Mulholland #60.P2.17) | 0.0 | low-impact |
| `61.P3.5` | Pass 3 | "Lt. Gov. Johnson" (Pass 2 caught) | Lt. Gov. Paul B. Johnson Jr. | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Gerald "Jerry" Heilbron (likely) | Gerald "Jerry" Heilbron (likely) | 2 | 2 |
| ? | Gerald "Jerry" Heilbron (likely) | Gerald "Jerry" Heilbron (likely) | 2 | 2 |
| ? | Judge John Minor Wisdom | Judge John Minor Wisdom | 2 | 2 |
...
The annotations in the master MD's `### 61. John and Jean Rosenberg` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

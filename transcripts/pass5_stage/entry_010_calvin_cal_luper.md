# Layer 5 fidelity findings — entry #10 Calvin "Cal" Luper
...
|---|---|---|---|---:|---|
| `10.13` | Pass 1 | Aunt Clara | Clara Luper | 0.0 | low-impact |
| `10.36` | Pass 1 | Akins | Atkins | 0.0 | low-impact |
| `10.P2.5` | Pass 2 | Melvin Porter | Melvin R. Porter | 0.0 | low-impact |
| `10.P3.5` | Pass 3 | Pass 3 historical correction | Wichita sit-in pre-dates OKC | 0.0 | low-impact |
...
| ? | Cal Luper / Calvin Luper | Cal Luper / Calvin Luper | 2 | 2 |
| ? | Marilyn Luper (Calvin's sister) | Marilyn Luper (Calvin's sister) | 2 | 2 |
| ? | Dunjee School / F.D. Moon (?) | Dunjee School / F.D. Moon (?) | 2 | 2 |
...
The annotations in the master MD's `### 10. Calvin "Cal" Luper` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

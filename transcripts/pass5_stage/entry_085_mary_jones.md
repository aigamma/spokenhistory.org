# Layer 5 fidelity findings — entry #85 Mary Jones
...
|---|---|---|---|---:|---|
| `85.4` | Pass 1 | Shepherd Elementary | Shepherd Elementary School (Albany) | 0.0 | low-impact |
| `85.20` | Pass 1 | Charles Charade / Charles Sherrod | Charles Sherrod | 0.0 | low-impact |
| `85.21` | Pass 1 | Bernie Reagan | Bernice Johnson Reagon | 0.0 | low-impact |
| `85.22` | Pass 1 | Rosa Harris | Rutha Mae Harris | 0.0 | low-impact |
| `85.23` | Pass 1 | Chief Preet | Chief Laurie Pritchett | 0.0 | low-impact |
| `85.P2.24` | Pass 2 | Cordele or Tifton | Cordele or Tifton (Georgia) | 0.0 | low-impact |
| `85.P4.29` | Pass 4 | "(Mr. Pays / Mr. Page)... he was a secretary" | Marion S. Page (Albany Movement Secretary) | 0.0 | low-impact |
...
| ? | First Bethel Baptist Church / Visit by W.E.B. Du Bois | First Bethel Baptist Church / Visit by W.E.B. Du Bois | 2 | 2 |
| ? | First Bethel | First Bethel | 2 | 2 |
...
The annotations in the master MD's `### 85. Mary Jones` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

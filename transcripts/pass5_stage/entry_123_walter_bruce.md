# Layer 5 fidelity findings — entry #123 Walter Bruce
...
|---|---|---|---|---:|---|
| `123.18` | Pass 1 | Ms. Carnegie | (Alma Mitchell) Carnegie | 0.0 | low-impact |
| `123.P2.5` | Pass 2 | At Latin | At Lexington (MS) | 0.0 | low-impact |
| `123.P2.35` | Pass 2 | Hayman | (Mr.) Hayden | 0.0 | low-impact |
| `123.P3.2` | Pass 3 | "the cold article → courthouse" (Pass 2 123.P2.17) | Common-noun Whisper failure | 0.0 | low-impact |
| `123.P3.3` | Pass 3 | "Lee Floreau / Leflore Counting → Leflore County" (Pass 2 123.P2.10) | Geographic Whisper failure | 0.0 | low-impact |
| `123.P3.4` | Pass 3 | "Tugelone → Tougaloo" recurring (Pass 2 123.P2.12) | Already in catalog row F | 0.0 | low-impact |
| `123.P3.5` | Pass 3 | "the lecture / Luxembourg → Lexington MS" (Pass 2 123.P2.28) | Geographic Whisper failure | 0.0 | low-impact |
| `123.P3.6` | Pass 3 | "Mrs. Ray → Mrs. (Victoria) Gray" (Pass 2 123.P2.47) | Already in canonical MFDP-trio | 0.0 | low-impact |
| `123.P3.7` | Pass 3 | "Sue and Henley Lorenzi → Sue and Henry Lorenzi" (Pass 2 123.P2.51) | Common spousal misrendering | 0.0 | low-impact |
| `123.P3.9` | Pass 3 | "the snake / SNCC" recurring (Pass 2 123.P2.42) | Already in catalog row H | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | (likely) Sheriff Smith | SNCC | 3 | 3 |
| ? | Dr. (Wilbert) McLean / McLeod | Dr. McLean | 2 | 2 |
| ? | Rolling Wall (Holmes County community) | Rolling Wall (Holmes County community) | 2 | 2 |
| ? | Rolling Wall (Holmes County community) | Rolling Wall (Holmes County community) | 2 | 2 |
| ? | (Hartman) Turnbow | (Hartman) Turnbow | 2 | 2 |
| ? | (Hartman) Turnbow | (Hartman) Turnbow | 2 | 2 |
| ? | (likely) Russell Whitaker | (likely) Russell Whitaker | 2 | 2 |
| ? | James Bourne | James Bourne | 2 | 2 |
| ? | (likely) Sai-Gon Pagoda / Holmes County church | (likely) Sai-Gon Pagoda / Holmes County church | 2 | 2 |
| ? | (likely) Rev. Crawford | (likely) Rev. Crawford | 2 | 2 |
| ? | the Mileston community | the Mileston community | 2 | 2 |
| ? | (likely) Tony Zivkovich (Teamsters Atlanta business agent) | (likely) Tony Zivkovich (Teamsters Atlanta business agent) | 2 | 2 |
...
The annotations in the master MD's `### 123. Walter Bruce` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #37 Elmer Dixon
...
| D3 — Catalog-vs-per-entry contradictions | 4 |
...
|---|---|---|---|---:|---|
| `37.18` | Pass 1 | Bunchy Carter | Alprentice "Bunchy" Carter | 0.0 | low-impact |
| `37.48` | Pass 1 | SIETAR (the work he does today) | SIETAR (Society for Intercultural Education, Training, and Research) | 0.0 | low-impact |
| `37.P2.11` | Pass 2 | the playground at Madrona (the cross-cultural neighborhood) | Madrona Playground (across the street from Dixon family home) | 0.0 | low-impact |
| `37.P3.2` | Pass 3 | "Stoke the Carmichael / Stoke Lee" (Pass-1 #37.6) | Stokely Carmichael (catalog #C entry) | 0.0 | low-impact |
| `37.P3.9` | Pass 3 | "Cointail Pro / Quantil Pro" (Pass-1 #37.16) | COINTELPRO (catalog #B entry) | 0.0 | low-impact |
| `37.P3.12` | Pass 3 | "Bunchy Carter" (Pass-1 #37.18) | Alprentice "Bunchy" Carter (catalog #D entry) | 0.0 | low-impact |
| `37.P3.14` | Pass 3 | "engin in their war" / "the enemy's war" (Pass-1 #37.25 / Pass-2 #35.P2.8) | The imperialist war / the Vietnam War | 0.0 | low-impact |
| `37.P3.17` | Pass 3 | "Khrushchev (bouncing his hand / shoe on the table)" (Pass-1 #37.38) | Nikita Khrushchev (1960 UN shoe-banging incident) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | The imperialist war / the Vietnam War | engaging in the war / the imperialist war | 3 | 3 |
| ? | Mao Zedong (Mao Tse-tung) | Mao Zedong (Mao Tse-tung) | 2 | 3 |
| ? | Madrona | Madrona | 2 | 3 |
| ? | Soledad State Prison (catalog #F entry) | Soledad State Prison (catalog #F entry) | 2 | 3 |
| ? | Madrona | Madrona | 2 | 2 |
| ? | House Un-American Activities Committee (HUAC) | House Un-American Activities Committee (HUAC) | 2 | 2 |
| ? | *Adventures in Paradise* (1959–62 ABC TV series); Kon-Tiki r | *Adventures in Paradise* (1959–62 ABC TV series); Kon-Tiki r | 2 | 2 |
...
|---|---|---|---|---|---|
| `37.10` | Mao Zai-Tung | Mao Zedong (Mao Tse-tung) | Catalog #D cluster: Che Guevara / Mao Zedong / Malcolm X | M-ext |  |
| `37.15` | House on American Activities Committee | House Un-American Activities Committee (HUAC) | HUAC (catalog #B entry) | B-ext |  |
| `37.P3.5` | "Mao Zai-Tung" (Pass-1 #37.10) | Mao Zedong (catalog #D entry) | Catalog #D cluster: Che Guevara / Mao Zedong / Malcolm X | M-ext |  |
| `37.P3.8` | "House on American Activities Committee" (Pass-1 #37.15) | HUAC (catalog #B entry) | House Un-American Activities Committee (HUAC) | B |  |
...
The annotations in the master MD's `### 37. Elmer Dixon` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

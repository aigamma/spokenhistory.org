# Layer 5 fidelity findings — entry #13 Carrie Lamar Young
...
|---|---|---|---|---:|---|
| `13.P2.13` | Pass 2 | Black Evil, McGee | Earle + McGehee, Arkansas | 0.0 | low-impact |
| `13.P2.25` | Pass 2 | LaGrange L.A.G.R.A.N.G.E. | LaGrange, Arkansas (Phillips County) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | John W. Walker | John W. Walker | 4 | 4 |
| ? | James Heel (likely a real SNCC member) | James Heel (likely a real SNCC member) | 2 | 2 |
| ? | James Heel (likely a real SNCC member) | James Heel (likely a real SNCC member) | 2 | 2 |
| ? | Ed Laredixon (likely from "Ed Lara Dixon" or similar Black-U | Ed Laredixon (likely from "Ed Lara Dixon" or similar Black-U | 2 | 2 |
| ? | Pulaski County (Arkansas) | Pulaski County (Arkansas) | 2 | 2 |
| ? | KOKY-AM (Little Rock Black radio station) | KOKY-AM (Little Rock Black radio station) | 2 | 2 |
| ? | Southern Christian Leadership Conference (SCLC) | Southern Christian Leadership Conference (SCLC) | 2 | 2 |
...
|---|---|---|---|---|---|
| `13.P2.19` | Stokely Carmichael / Stoke Lynn | Stokely Carmichael (Kwame Ture) | Kwame Ture (1941-98) | C-ext |  |
...
The annotations in the master MD's `### 13. Carrie Lamar Young` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

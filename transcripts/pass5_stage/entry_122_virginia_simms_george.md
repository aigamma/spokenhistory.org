# Layer 5 fidelity findings — entry #122 Virginia Simms George
...
|---|---|---|---|---:|---|
| `122.21` | Pass 1 | Assabet Valley | Assabet Valley Regional School District | 0.0 | low-impact |
| `122.P2.7` | Pass 2 | Charles Sherrod's wife | Shirley Miller Sherrod | 0.0 | low-impact |
| `122.P3.1` | Pass 3 | "Pinkston → Prince Pink" (Pass 2 122.P2 note) | Add catalog row for Pinkston Whisper-rendering pattern | 0.0 | low-impact |
| `122.P3.2` | Pass 3 | "Sallasin → unchanged" (Pass 2 122.P2 note) | n/a — already canonical | 0.0 | low-impact |
| `122.P3.4` | Pass 3 | "Thalhimers → Taham / Talham" (Pass 2 122.P2 note) | Add catalog row for Thalhimers Whisper-rendering pattern | 0.0 | low-impact |
| `122.P3.5` | Pass 3 | "Raleigh University → Shaw University" (Pass 2 122.P2.27) | Critical Pass-1 miss: canonical 1960 SNCC founding conference at Shaw University | 0.0 | low-impact |
| `122.P3.6` | Pass 3 | "Pearly Rings → Pearl Earrings" (Pass 2 122.P2.6) | Common-noun debutante-context Whisper failure | 0.0 | low-impact |
| `122.P3.9` | Pass 3 | "BPU → BYPU (Baptist Young People's Union)" (Pass 2 122.P2.26) | Canonical Black-Baptist HBCU institution acronym | 0.0 | low-impact |
| `122.P4.28` | Pass 4 | Did I really for my life | Did I fear for my life | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Marie (Sallasin) and Pat (Patricia Washington) | Marie (Sallasin) and Pat (Patricia Washington) | 2 | 2 |
| ? | Philadelphia | Philadelphia | 2 | 2 |
| ? | (Lionel) Richie | (Lionel) Richie | 2 | 2 |
...
The annotations in the master MD's `### 122. Virginia Simms George` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

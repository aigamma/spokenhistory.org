# Layer 5 fidelity findings — entry #126 William G. Anderson
...
|---|---|---|---|---:|---|
| `126.32` | Pass 1 | Newton in Baker County | Newton, Georgia (Baker County) | 0.0 | low-impact |
| `126.P2.14` | Pass 2 | March of Luther King, Jr. | Martin Luther King Jr. | 0.0 | low-impact |
| `126.P2.38` | Pass 2 | Tuskegee Veterans House Bill | Tuskegee Veterans Hospital | 0.0 | low-impact |
| `126.P3.3` | Pass 3 | "the next million / the National Union" (Lucy P2.13) parallel pattern | the National (Union) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Des Moines (University) Still College of Osteopathic Medicin | Des Moines (University) Still College of Osteopathic Medicin | 2 | 2 |
| ? | William L. Reese (likely Bill Reese) | William L. Reese (likely Bill Reese) | 2 | 2 |
| ? | E.D. (Joe) Jordan / E.D. "Joe" Jorisi | E.D. (Joe) Jordan / E.D. "Joe" Jorisi | 2 | 2 |
...
The annotations in the master MD's `### 126. William G. Anderson` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

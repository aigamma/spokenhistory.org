# Layer 5 fidelity findings — entry #62 John Carlos
...
|---|---|---|---|---:|---|
| `62.11` | Pass 1 | McCombs Park / McCom Park | McCombs Dam Park | 0.0 | low-impact |
| `62.P2.26` | Pass 2 | McCombs Park / McCom Park | McCombs Dam Park | 0.0 | low-impact |
| `62.P2.38` | Pass 2 | Michaux's bookstore | Lewis Michaux's National Memorial African Bookstore | 0.0 | low-impact |
| `62.P2.74` | Pass 2 | the Pink Pussycat | The Pink Pussycat (Greenwich Village) | 0.0 | low-impact |
| `62.P2.78` | Pass 2 | Iceland and Greenland | Iceland / Greenland | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | Detective Brown (NYPD 32nd Precinct) | Detective Brown (NYPD 32nd Precinct) | 2 | 3 |
| ? | Earl Carlos / Earl Jr. / Andrew Carlos | Earl Carlos / Earl Jr. / Andrew Carlos | 2 | 2 |
| ? | Detective Brown (NYPD 32nd Precinct) | Detective Brown (NYPD 32nd Precinct) | 2 | 2 |
...
The annotations in the master MD's `### 62. John Carlos` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

# Layer 5 fidelity findings — entry #38 Emmett W. Bassett and Priscilla Tietjen Bassett
...
|---|---|---|---|---:|---|
| `38.8` | Pass 1 | St. Paul, in Lawrence, Virginia | Saint Paul's College, in Lawrenceville, Virginia | 0.0 | low-impact |
| `38.12` | Pass 1 | Tuskegee Army Air Force | Tuskegee Army Airfield / Tuskegee Airmen | 0.0 | low-impact |
| `38.41` | Pass 1 | Patron-lin | patulin | 0.0 | low-impact |
| `38.P2.6` | Pass 2 | Ella Baker (implied via In Friendship) | Ella Baker | 0.0 | low-impact |
| `38.P3.4` | Pass 3 | "Lyndon Johnson" / "LBJ" in War-on-Poverty context | Lyndon B. Johnson | 0.0 | low-impact |
...
| ? | Bayard Rustin | Bayard Rustin | 2 | 2 |
...
The annotations in the master MD's `### 38. Emmett W. Bassett and Priscilla Tietjen Bassett` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

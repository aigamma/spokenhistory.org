# Layer 5 fidelity findings — entry #44 Freddie Greene (Biddle)
...
|---|---|---|---|---:|---|
| `44.P2.2` | Pass 2 | Hollis and MacArthur Cotton | Hollis Watkins and MacArthur Cotton | 0.0 | low-impact |
| `44.P2.5` | Pass 2 | snake (corpus-recurring) | SNCC | 0.0 | low-impact |
| `44.P3.1` | Pass 3 | Greene↔Hollis Watkins cross-corpus name | Hollis Watkins (recurring catalog figure) | 0.0 | low-impact |
| `44.P4.24` | Pass 4 | Howard Street 1600s | Howard Street 1600 block / Howard Street the 1600s block | 0.0 | low-impact |
...
| ? | Likely Dona Moses née Richards (Bob Moses's first wife, m. 1 | Janet (Jemmott) Moses | 2 | 2 |
| ? | Atlantic City (NJ) | Atlantic City, New Jersey | 2 | 2 |
| ? | NAG friends (Nonviolent Action Group, Howard) | NAG friends (Nonviolent Action Group, Howard) | 2 | 2 |
...
The annotations in the master MD's `### 44. Freddie Greene (Biddle)` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

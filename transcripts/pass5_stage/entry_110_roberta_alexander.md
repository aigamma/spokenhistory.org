# Layer 5 fidelity findings — entry #110 Roberta Alexander
...
|---|---|---|---|---:|---|
| `110.52` | Pass 1 | First Assisi Camp | Civilian Conservation Corps (CCC) | 0.0 | low-impact |
| `110.P2.15` | Pass 2 | Su language / Sioux Indian | Sioux (language/people) | 0.0 | low-impact |
| `110.P2.33` | Pass 2 | the anti-Tokyo-International-Airport farmer-led demonstrations | the Sanrizuka Struggle / anti-Narita-Airport farmer protests | 0.0 | low-impact |
| `110.P2.43` | Pass 2 | PC 182.5 | California Penal Code §182.5 (gang conspiracy enhancement) | 0.0 | low-impact |
| `110.P2.55` | Pass 2 | the labors local | the laborers' local (LIUNA Local) | 0.0 | low-impact |
| `110.P2.56` | Pass 2 | William Knowland | William F. Knowland | 0.0 | low-impact |
| `110.P2.70` | Pass 2 | Mao and the revolution marks | Mao + revolutionary Marx (writings) | 0.0 | low-impact |
| `110.P2.76` | Pass 2 | Roberta giving speech at UCSD anti-noose / anti-cookie / anti-Cucks | UCSD "Compton Cookout" + noose incident February 2010 | 0.0 | low-impact |
| `110.P3.1` | Pass 3 | "Su / Susie / Su City Iowa" | Sioux / Sioux City IA | 0.0 | low-impact |
| `110.P3.2` | Pass 3 | "Aptecker / Abtecker" | Aptheker | 0.0 | low-impact |
| `110.P3.13` | Pass 3 | "Charles Bussey / Charles Burcy" | Charles Bursey | 0.0 | low-impact |
| `110.P3.16` | Pass 3 | "Idle / Undy" | Hendaye / Hendaia | 0.0 | low-impact |
| `110.P3.20` | Pass 3 | "labors local" | laborers' local (LIUNA Local) | 0.0 | low-impact |
...
|---|---|---|---:|---:|
| ? | (Friden) Justowriter | (Friden) Justowriter | 3 | 4 |
| ? | Julius + Ethel Rosenberg (the Rosenbergs) | Julius + Ethel Rosenberg (the Rosenbergs) | 2 | 3 |
| ? | Elbert "Big Man" Howard | Big Man Howard (Elbert "Big Man" Howard) | 2 | 2 |
| ? | Civilian Conservation Corps (CCC) | Civilian Conservation Corps (CCC) | 2 | 2 |
| ? | (likely) across the street from LA City Hall | (likely) across the street from LA City Hall | 2 | 2 |
| ? | (likely) the M16 (rifle) | (likely) the M16 (rifle) | 2 | 2 |
...
|---|---|---|---|---|---|
| `110.11` | Brosenbergs | (Julius and Ethel) Rosenbergs | Julius + Ethel Rosenberg | E-ext |  |
...
The annotations in the master MD's `### 110. Roberta Alexander` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

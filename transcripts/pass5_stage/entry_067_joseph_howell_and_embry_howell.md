# Layer 5 fidelity findings — entry #67 Joseph Howell and Embry Howell
...
|---|---|---|---|---:|---|
| `67.P2.13` | Pass 2 | Joe Mosnier — NOT this interviewer; David Cline is the canonical Howell intervie | David Cline (Virginia Tech history dept, SOHP) | 0.0 | low-impact |
| `67.P2.16` | Pass 2 | Joseph T. Howell III, Joseph T. Howell Jr., president of Nashville City Banks | Joseph T. Howell III, Joseph T. Howell Jr., president of Nashville City Bank | 0.0 | low-impact |
| `67.P2.18` | Pass 2 | wait until they don't have to put up with me | (speaker recall of getting in trouble) | 0.0 | low-impact |
| `67.P2.28` | Pass 2 | ITS, inter-denominational theological seminary | ITC, Interdenominational Theological Center (Atlanta) | 0.0 | low-impact |
...
| ? | Barber-Scotia (College) | Barber-Scotia (College) | 2 | 2 |
| ? | Johnson C. Smith (University) | Johnson C. Smith (University) | 2 | 2 |
...
|---|---|---|---|---|---|
| `67.18` | Barbara Scotian | Barber-Scotia (College) | Johnson C. Smith University / Barber-Scotia College | F-ext |  |
...
The annotations in the master MD's `### 67. Joseph Howell and Embry Howell` section identify each Layer-5-flagged row. The adversarial multi-model ensemble (Kiro / Kimi / Codex / Gemini) is the next adjudication layer for items not auto-resolved.

...
| 109.8 | Petna Dalico                                      | Pete Daniel (likely)                            | low        | Stage-3 LLM                     | Videographer; canonical historian Pete Daniel has done SOHP-affiliated work // [PASS-6: rejected — speculation without corroboration | see transcripts/low_conf_resolutions/entry_109.json] |
...
| #       | Span as Whisper-transcribed | Suggested correction | Confidence | Source | Surrounding context |
|---------|---|---|---|---|---|
| 109.P2.1 | Petna Dalico | Pete Daniel (likely cameraman) | low | Stage-3 LLM | Cross-reference Pass 1 109.8; canonical historian Pete Daniel could have been on SOHP-affiliated work, but this is a low-confidence ID — Whisper severely garbled the videographer credit // [PASS-6: rejected — speculation without corroboration | see transcripts/low_conf_resolutions/entry_109.json] |
...
| 109.P2.12 | electrically | "elect locally" / through (local) elections | high | Stage-3 LLM | "we were going to take over one of the calories. Electrically. You know, there's... That was... That was planned"; Whisper homophone for "electorally" — speaker describing canonical SNCC-Sherrod strategy of taking over rural Southwest GA county governments via Black majority voter registration + election // [LAYER-5: D2-ambiguous, ensemble-adjudication-pending] |
...
| 109.P3.8 | "electrically" | electorally | high | catalog-new | Pass 2 109.P2.12. Add to common-noun catalog (election-process terminology). // [LAYER-5: D2-ambiguous, ensemble-adjudication-pending] |

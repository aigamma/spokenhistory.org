...
**Current catalog: 190 pages (161 interviewees + 29 external figures, as of 2026-05-28).** Every named CRHP interviewee plus every named external figure referenced in FamousNames, the influence graph, OR repeatedly mentioned across multiple interviewee bios has a catalog entry. Photo coverage: 46 of 190 pages (24%) carry an inline PD or open-licensed portrait.

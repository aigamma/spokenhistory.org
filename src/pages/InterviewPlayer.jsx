...
export default function InterviewPlayer() {
  ...
  if (error) {
    return (
      <div className="bg-red-50 border border-red-200 text-red-700 dark:border-red-900 dark:text-red-300 px-6 py-4 rounded-xl">
        <p>
            ...
            {mainSummary && (
              <>
                ...
                <button
                  ...
                  className="text-civil-red-body text-base font-mono hover:text-red-700 dark:hover:text-red-300 transition-colors cursor-pointer min-h-11 inline-flex items-center"
                >
          ...
          <div className="mb-14">
            ...
            {subSummaries.map((summary, index) => (
              <div key={summary.id || index} className="w-full mb-8">
                <button
                  type="button"
                  className="text-civil-red-body text-base font-mono mb-2 cursor-pointer hover:text-red-700 dark:hover:text-red-300 transition-colors min-h-11 inline-flex items-center text-left disabled:opacity-50 disabled:cursor-not-allowed"
                  onClick={() => {

...
export default function SearchPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 bg-gray-50 dark:bg-zinc-900 min-h-screen font-sans flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-3xl text-center mb-16">
        ...
        <p className="text-base leading-relaxed text-gray-600 dark:text-zinc-400 mb-10 max-w-xl mx-auto">
        ...
        <form onSubmit={handleSearch} className="w-full">
          <div className="relative w-full">
            ...
            <div className="absolute inset-y-0 left-0 flex items-center pl-4 pointer-events-none">
              <SearchIcon className="w-5 h-5 text-gray-500 dark:text-zinc-400" aria-hidden="true" />
            </div>
            ...
            <input
              ...
              className="w-full pl-12 pr-32 py-5 min-h-11 border border-gray-200 dark:border-zinc-700 bg-white dark:bg-zinc-800 rounded-xl shadow-sm outline-none text-base text-gray-900 dark:text-zinc-100 transition-all duration-300 focus:shadow-blue-300 focus:ring-2 focus:ring-blue-500"
              autoCapitalize="none"
              autoCorrect="off"
              aria-invalid={!!error}
          ...
          <div className="flex flex-wrap gap-2" role="group" aria-label="Popular keyword shortcuts">
            ...
            {['civil rights', 'voting', 'education', 'segregation', 'protests', 'leadership', 'communities', 'legislation', 'equality', 'freedom'].map((keyword) => (
              <button
                ...
                className="px-4 py-2 min-h-11 bg-gray-100 dark:bg-zinc-800 text-gray-700 dark:text-zinc-300 rounded-lg text-sm border-none cursor-pointer transition-colors duration-200 hover:bg-blue-100 dark:hover:bg-blue-900 hover:text-blue-800 dark:hover:text-blue-200"

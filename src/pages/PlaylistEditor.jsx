      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-lg p-6">
            <div className="mb-4">
              <h2 className="text-2xl font-bold mb-2 text-stone-900 dark:text-zinc-100">Playlist Info</h2>
              <p id="totalDuration" className="text-stone-900 dark:text-zinc-200">
            ...
            <div className="mb-4">
              <div className="flex justify-between items-center mb-2">
                <h3 className="text-xl font-semibold text-stone-900 dark:text-zinc-100" id="playlist-summary-heading">Playlist Summary</h3>
              ...
              {isEditingDescription ? (
                <div className="space-y-2">
                  ...
                  <textarea
                    ...
                    className="w-full h-40 p-2 border rounded dark:bg-zinc-800 dark:border-zinc-700 dark:text-zinc-100 dark:placeholder-zinc-500"
                  ...
                  <div className="flex justify-end space-x-2">
                    <button
                      ...
                      className="px-4 py-2 min-h-11 text-gray-700 hover:text-gray-900 dark:text-zinc-300 dark:hover:text-zinc-100"
                    >
                      Cancel
                    </button>
                    <button
                ...
                <p id="overallSummaryContent" className="text-gray-700 dark:text-zinc-300" />
              )}
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-lg shadow-lg p-6">
            {currentVideo && (
              <>
                <div className="mb-4">
                  <h2 className="text-2xl font-bold text-stone-900 dark:text-zinc-100">{currentVideo.name}</h2>
                  <p className="text-gray-600 dark:text-zinc-400">{currentVideo.role}</p>
                </div>
                  ...
                  <Droppable droppableId="timeline" direction="horizontal">
                    {(provided) => (
                      <div
                        ...
                        className="relative h-20 bg-gray-100 dark:bg-zinc-800 rounded mb-4"
                      >
                              ...
                              {(provided, snapshot) => (
                                <div
                                  ...
                                  className={`relative h-full cursor-move transition-colors
                                    ${index === currentVideoIndex ? 'bg-blue-500 dark:bg-blue-600' : 'bg-gray-300 dark:bg-zinc-600'}
                ...
                <div className="flex justify-center space-x-4" role="group" aria-label="Playback controls">
                  <button
                    ...
                    className="min-w-11 min-h-11 p-2 rounded-full bg-gray-200 hover:bg-gray-300 dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:text-zinc-100 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center justify-center"
                  >
                ...
                <div className="mt-6">
                  <h3 className="text-xl font-semibold mb-2 text-stone-900 dark:text-zinc-100">Summary</h3>
                  <p className="text-gray-700 dark:text-zinc-300">{currentVideo.summary}</p>
                </div>
              </>
            )}
          </div>

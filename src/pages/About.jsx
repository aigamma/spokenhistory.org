    ...
    <div className="min-h-screen overflow-hidden bg-[#EBEAE9] dark:bg-stone-900">
      ...
      <div className="px-4 sm:px-8 lg:px-12">
        ...
        <div className="pt-4 pb-16">
          <div className="border-b border-black dark:border-stone-700 pb-4 mb-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            ...
            <div className="space-y-6">
              <div className="text-left">
                <span className="text-black dark:text-stone-200 text-4xl font-normal font-['Source_Serif_Pro']">This site is a resource for exploring the Library of Congress </span>
                <a 
                ...
                <span className="text-black dark:text-stone-200 text-4xl font-normal font-['Source_Serif_Pro']"> , offering new ways to navigate and connect the stories of those who lived through the movement.</span>
              </div>
              
              <p className="text-black dark:text-stone-200 text-2xl font-medium font-['Lora'] leading-relaxed">
              The <a 
                href="https://www.loc.gov/collections/civil-rights-history-project/about-this-collection/" 
                target="_blank" 
                rel="noopener noreferrer"
        ...
        {/* Team Section */}
        <div className="py-16">
          <div className="border-b border-black dark:border-stone-700 pb-4 mb-16">
        ...
        <div className="py-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-black dark:text-stone-200 text-2xl font-medium font-['Lora']">

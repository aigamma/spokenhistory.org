...
export default function About() {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[#EBEAE9] dark:bg-zinc-900">
      {/* Main Content */}
      <div className="px-4 sm:px-8 lg:px-12">
        
        {/* About the Project Section */}
        <div className="pt-4 pb-16">
          <div className="border-b border-black dark:border-zinc-700 pb-4 mb-8">
        ...
        {/* Team Section */}
        <div className="py-16">
          <div className="border-b border-black dark:border-zinc-700 pb-4 mb-16">
        ...
        <div className="py-16">
          ...
          <div className="space-y-4">
            ...
            <p className="text-black dark:text-zinc-200 text-2xl font-medium font-['Lora']">

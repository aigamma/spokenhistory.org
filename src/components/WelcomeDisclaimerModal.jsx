      ...
      >
        ...
        <div className="sticky top-0 px-8 py-8 border-b-2 border-red-500 bg-[#EBEAE9] dark:bg-stone-900">
          <div className="flex items-start justify-between">
            ...
            <button
              ...
              type="button"
              onClick={onClose}
              className="inline-flex items-center justify-center min-w-11 min-h-11 text-black dark:text-stone-100 hover:text-civil-red-strong transition ml-4 flex-shrink-0"
        ...
        <div className="px-8 py-8 space-y-8">
          ...
          <div className="border-l-4 border-red-500 pl-6 py-2">
            ...
            <p className="text-black dark:text-stone-200 text-base lg:text-lg font-normal font-['Source_Serif_4'] leading-relaxed">
          ...
          {/* AI Organization */}
          <div className="border-l-4 border-black dark:border-stone-600 pl-6 py-2">
            <h3 className="text-black dark:text-stone-100 text-xl lg:text-2xl font-medium font-['Inter'] mb-3">
          ...
          <div className="border-2 border-red-500 p-6">
            ...
            <div className="text-black dark:text-stone-200 text-base lg:text-lg font-normal font-['Source_Serif_4'] leading-relaxed space-y-3">
              <p>
          ...
          {/* Feedback System */}
          <div className="border-2 border-black dark:border-stone-600 p-6">
            <h3 className="text-black dark:text-stone-100 text-xl lg:text-2xl font-medium font-['Inter'] mb-3">
              Help Us Improve: Use the Feedback System
            </h3>
            <div className="text-black dark:text-stone-200 text-base lg:text-lg font-normal font-['Source_Serif_4'] leading-relaxed space-y-4">
              <p>
          ...
          <div className="text-center py-4">
            <p className="text-black dark:text-stone-200 text-base lg:text-lg font-normal font-['Source_Serif_4'] leading-relaxed max-w-2xl mx-auto">

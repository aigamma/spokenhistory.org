...
export default function PeopleGrid() {
    ...
    return (
      <div className="fixed inset-0 flex items-center justify-center z-50 p-4">
        ...
        <div
          ...
          className="bg-white/95 dark:bg-zinc-800/95 backdrop-blur-sm rounded-2xl shadow-xl max-w-md w-full overflow-hidden animate-fadeIn z-50 relative border border-white/30 dark:border-zinc-700"
        >
          {/* Modal Header */}
          ...
          {/* Modal Body */}
          <div className="p-6">
            <h2 id="person-modal-title" className="text-2xl font-bold text-black dark:text-zinc-100 mb-2" style={{
              fontFamily: 'Freight Text Pro, Lora, serif'
            }}>{person.name}</h2>
            <p className="text-black/70 dark:text-zinc-400 mb-6 font-mono tracking-wide text-sm">{person.role}</p>
      ...
      <div className="flex flex-col items-center space-y-2">
        ...
        >
          {person.thumbnailUrl ? (
            ...
            <div className="w-full h-full bg-black/20 dark:bg-white/10 flex items-center justify-center">
              <span className="text-black/40 dark:text-zinc-400 text-xs font-mono">No photo</span>
            </div>
          )}
        </button>
        ...
        <div className="text-center w-full">
          <p className={`text-xs sm:text-sm truncate max-w-full ${
            isSelected ? 'font-bold' : 'text-black/80 dark:text-zinc-300'
          }`} style={{
  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="animate-spin rounded-full h-12 w-12 border-4 border-black/20 dark:border-white/20" style={{
  ...
  if (error) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="text-black/70 dark:text-zinc-300" style={{
          fontFamily: 'Freight Text Pro, Lora, serif'
        }}>{error}</div>
      </div>
    );
  ...
  if (people.length === 0) {
    return (
      <div className="flex justify-center items-center h-64">
        <div className="text-black/60 dark:text-zinc-400" style={{
          fontFamily: 'Freight Text Pro, Lora, serif'
  ...
  return (
    <>
      ...
      <div className="mb-6 max-w-xl mx-auto">
        <div className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 mb-6 border border-white/20 dark:border-zinc-700">
          <div className="text-center">
            ...
            <input
              ...
              className="w-full p-3 border border-black/20 dark:border-zinc-600 rounded-md focus:outline-none focus:ring-2 focus:border-black/40 dark:focus:border-zinc-400 transition-colors bg-white/80 dark:bg-zinc-800/80 dark:text-zinc-100 backdrop-blur-sm"
              style={{
                fontFamily: 'Freight Text Pro, Lora, serif'
              }}
            />
      ...
      {/* People Grid */}
      <div className="bg-white/80 dark:bg-zinc-800/80 backdrop-blur-sm rounded-2xl shadow-lg p-6 border border-white/20 dark:border-zinc-700">

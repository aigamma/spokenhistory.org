    ...
    <div className="rag-interview-map">
      ...
      <div className="rounded-lg border border-stone-200 bg-stone-50 overflow-hidden">
        {/* SVG substrate + interior fills branch on isDark (useIsDark): the inline
            background ('#fafaf9' light / '#18181b' dark), the quadrant guidelines
            ('#e7e5e4' light / '#292524' dark), the empirical axis labels ('#57534e'
            light / '#a8a29e' dark), and the dot name labels (fills '#18181b' /
                ...
                >
                  ...
                  {(isMatch || isFocus || isNeighbor) && (
                    <text
                      ...
                      fill={isFocus ? (isDark ? '#f5f5f4' : '#18181b') : (isNeighbor ? '#B23E2F' : (isDark ? '#d6d3d1' : '#44403c'))}
